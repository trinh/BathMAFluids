...
},
{
  ...
  "number": "",
  "title": "Changelog",
  "body": " Changelog  When possible (likely weekly), we will update the changelog to indicate relevant updates to the course notes.     26 September 2025: the Introduction was largely completed with the review of complex variables; the first worksheet was completed.   3 October 2025: Add new problems to the worksheet in Ch. 3 (problems 4, 5, 6). Add material to Ch. 7.   10 October 2025: Add Homsy (Ed.) Multimedia Fluid Mechanics Online; Update Ch.7.    "
},
{
...
{
  "id": "sec-preliminary-complex-variables-11-8-1",
  "level": "2",
  "url": "sec-preliminary-complex-variables.html#sec-preliminary-complex-variables-11-8-1",
  "type": "Definition",
  "number": "1.2.5",
...
{
  "id": "sec-preliminary-complex-variables-12-3-1",
  "level": "2",
  "url": "sec-preliminary-complex-variables.html#sec-preliminary-complex-variables-12-3-1",
  "type": "Figure",
  "number": "1.2.7",
  "title": "",
...
{
  "id": "sec-preliminary-complex-variables-12-6-1",
  "level": "2",
  "url": "sec-preliminary-complex-variables.html#sec-preliminary-complex-variables-12-6-1",
  "type": "Remark",
  "number": "1.2.8",
  "title": "",
...
},
{
  ...
  "body": " Plotting a Riemann surface  Select the branch cut of that runs along the positive real axis.    Consider a contour that starts from , then encircles the origin (anticlockwise) and returns to . What is the jump in the value of at the end of the contour as compared to the start?    By hand, plot the Riemann surface as visualised in , , where . You may also confirm your sketch with a computational tool, if desired.       At the start, we have . At the end, we have . In fact, you can observe this in .    This is tricky to plot but give it a shot! It should look like the below.  Imaginary part of the square root function   Sqrt        "
},
{
  "id": "ex-branch1",
  "level": "2",
  ...
  "body": " A function with two branch points  Consider the function :    Choose the branch cut from in the positive real direction. Choose the branch cut from in the negative real direction. Write either or for and defined as relative angles from the two branch points. Show that: (i) when is encircled by a complete revolution, the function jumps in value by a factor of ; (ii) that there is a similar jump in value when is encircled. Finally what happens if (iii) is encircled?  Draw a picture of the final -plane, showing the branch cuts.    Consider now a branch cut from that tends in the positive real direction and the branch cut from tends in the positive real direction as well. Repeat the experiment above, considering (i)-(iii). Conclude that there is no jump in value along the region and hence the branch cuts required only extends between .  Draw a picture of the final -plane, showing the branch cuts.    (Challenging). If you consider a plot of or , what will the Riemann surface look like? You can attempt to plot this using any tool.     "
},
{
  "id": "ex-log",
  "level": "2",
...
{
  "id": "sec-flowexamples-14-3-1",
  "level": "2",
  "url": "sec-flowexamples.html#sec-flowexamples-14-3-1",
  "type": "Example",
  "number": "2.2.4",
...
{
  "id": "sec-flowexamples-14-4",
  "level": "2",
  "url": "sec-flowexamples.html#sec-flowexamples-14-4",
  "type": "Example",
  "number": "2.2.5",
...
{
  "id": "sec-flowexamples-14-5",
  "level": "2",
  "url": "sec-flowexamples.html#sec-flowexamples-14-5",
  "type": "Example",
  "number": "2.2.7",
...
},
{
  ...
  "type": "Worksheet Exercise",
  "number": "2.3.1",
  "title": "Flow visulisation.",
  "body": " Flow visulisation   Watch the first 13 and half minutes of the video \"Flow visualisation\" from the NCFMF archives .   Name a few ways in which a fluid flow can be visualised (i.e. how does one produce, in an experiment, such a visualisation?)    Define, in words, what pathline , streakline , timeline , and streamline means. At 6:30, the author comments that \"there is no way to make a streamline visible\". Discuss this point.    Give the example, shown in the video, where the pathline, streakline, and streamlines all coincide. Draw pictures to illustrate the concept.    Give an example, shown in the video, where the pathline, streakline, and streamlines do not coincide. Draw pictures to illustrate the concept.    In the video, an intuitive explanation is given for what it means for the velocity to be incompressible . What is this explanation? (near 8:25)     "
},
{
...
},
{
  ...
  "body": " Eulerian and Lagrangian descriptions   A velocity field is described in Eulerian terms in Cartesian coordinates by .   What is the Lagrangian position of the particle that starts at the point ? Describe its path. What is its velocity?    Express the position and velocity in polar coordinates. What do you notice?         A particle moves with the velocity of the fluid. Then it must satisfy the equations Trying solutions of the form gives , so the general solution is or, equivalently, where and are constants, and Setting and gives and , so This is a circular path of radius going anticlockwise around the origin. The velocity is     The calculation works out more simply in polar coordinates; the velocity field is where is the angular unit vector given in . Then the equation for particle paths is Thus and , where . The velocity is .       "
},
{
...
},
{
  "id": "subsec-RTT-6-1",
  "level": "2",
  "url": "sec-RTT.html#subsec-RTT-6-1",
  "type": "Remark",
  "number": "3.1.7",
...
},
{
  ...
  "level": "2",
  "url": "ch-chapter03-equations-4.html#ch-chapter03-equations-4-5",
  "type": "Remark",
  "number": "3.2.2",
  "title": "Use of the bump lemma.",
  "body": " Use of the bump lemma  Within the above proof, we use an idea used throughout this chapter, which is that if an integral of a quantity (the integrand) is zero for all possible domains of integration, then the integrand, itself, is zero. This is sometimes referred to as the \"Bump lemma\". In , you will prove this lemma.  "
},
{
  "id": "fig-normalvolume",
  "level": "2",
...
{
  "id": "ch-chapter03-equations-4-6-4-1",
  "level": "2",
  "url": "ch-chapter03-equations-4.html#ch-chapter03-equations-4-6-4-1",
  "type": "Theorem",
  "number": "3.2.4",
...
{
  "id": "ch-chapter03-equations-4-6-4-2",
  "level": "2",
  "url": "ch-chapter03-equations-4.html#ch-chapter03-equations-4-6-4-2",
  "type": "Proof",
  "number": "1",
  "title": "",
...
{
  "id": "sec-bernoulli-14-1",
  "level": "2",
  "url": "sec-bernoulli.html#sec-bernoulli-14-1",
  "type": "Example",
  "number": "3.5.9",
  "title": "Aiflow into or out of a room.",
  "body": " Aiflow into or out of a room  During the lecture, just for fun, we will play this video by Matthias Wandel about airflow out of a room. This is somewhat related to Bernoulli's equation (the connection between pressure and velocity), though the situation is considerably more difficult.  "
},
{
  "id": "sec-bernoulli-15-1",
  "level": "2",
  "url": "sec-bernoulli.html#sec-bernoulli-15-1",
  "type": "Example",
  "number": "3.5.10",
...
},
{
  ...
  "number": "3.6.2",
  "title": "Bump lemma.",
  "body": " Bump lemma  Within our derivations of the governing equations, we often make use of the following lemma:  Bump lemma   Let be a sufficiently smooth function defined on . Suppose it is the case that for all . Then in .     Give a proof of the lemma.   This proof assumes that the function is not pathological (e.g. it cannot oscillate infinitely fast, take different values for rational vs. irrational, etc.). That's what we mean by \"sufficiently smooth\".  Assume that there exists a point where . Suppose without loss of generality here. Since is sufficiently smooth (and in particular, it is continuous), then there exists a non-trivial neighbourhood near where everywhere in this neighbourhood, say . Then , contradicting the assumption. Therefore must be zero everywhere.   "
},
{
  "id": "ex-leibnitz-rule",
  "level": "2",
...
{
  "id": "boundaries-surfaces-interfaces-4-3-1",
  "level": "2",
  "url": "boundaries-surfaces-interfaces.html#boundaries-surfaces-interfaces-4-3-1",
  "type": "Remark",
  "number": "7.2.6",
...
{
  "id": "boundaries-surfaces-interfaces-5-4",
  "level": "2",
  "url": "boundaries-surfaces-interfaces.html#boundaries-surfaces-interfaces-5-4",
  "type": "Example",
  "number": "7.2.9",
...
{
  "id": "boundaries-surfaces-interfaces-5-5",
  "level": "2",
  "url": "boundaries-surfaces-interfaces.html#boundaries-surfaces-interfaces-5-5",
  "type": "Example",
  "number": "7.2.11",
  "title": "Meniscus.",
...
{
  "id": "subsec-stress-tensor-3-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-3-1",
  "type": "Definition",
  "number": "7.3.9",
...
{
  "id": "subsec-stress-tensor-4-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-4-1",
  "type": "Remark",
  "number": "7.3.10",
...
{
  "id": "subsec-stress-tensor-5-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-5-1",
  "type": "Remark",
  "number": "7.3.11",
...
{
  "id": "subsec-stress-tensor-6-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-6-1",
  "type": "Remark",
  "number": "7.3.14",
...
{
  "id": "subsec-stress-tensor-7-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-7-1",
  "type": "Remark",
  "number": "7.3.15",
...
{
  "id": "subsec-stress-tensor-8-1",
  "level": "2",
  "url": "sec-stress.html#subsec-stress-tensor-8-1",
  "type": "Remark",
  "number": "7.3.16",
  "title": "Special case of a fluid at rest.",
  "body": " Special case of a fluid at rest  In a fluid at rest we have , and thus , where is the identity matrix, meaning that is a multiple of the identity matrix.  "
},
{
...
},
{
  ...
  "body": " Incompressible Newtonian fluid   We can define a Newtonian fluid by stating its constitutive relationship. where is the dynamic shear viscosity . In vector form where is the rate-of-strain tensor, given by with which we can also write as:    "
},
{
  "id": "subsec-newtonian-fluids-3-1",
  "level": "2",
  "url": "subsec-newtonian-fluids.html#subsec-newtonian-fluids-3-1",
  "type": "Remark",
  "number": "7.4.2",
...
{
  "id": "subsec-newtonian-fluids-4-1",
  "level": "2",
  "url": "subsec-newtonian-fluids.html#subsec-newtonian-fluids-4-1",
  "type": "Remark",
  "number": "7.4.3",
...
},
{
  ...
  "body": " Conservation of linear momentum  We consider the balance of linear momentum in a small cube of side length for an incompressible fluid .  Small cube used to derive the equations of motion   Small cube   To do this we employ the Reynolds Transport Theorem , with equal to the linear momentum of the fluid per unit volume, , and being the small volume of fluid under consideration, which coincides with the cube at time (however, note that the volume of fluid we are following is not generally a cube at other times). The theorem states that:   We note that is the integral of the linear momentum per unit volume over the volume and is therefore the total momentum of the fluid particles in . The left-hand side of this equation is thus the Lagrangian rate of change of momentum of these fluid particles. By Newton's second law, this must equal the total force acting on the fluid in , which we denote by . This force has different contributions, which can be categorised into body forces (which act on the whole control volume) and surface forces (acting only on the surface, which arise from the fluid stress). In this course, the contributions to the force are:    Body forces: usually equal to either zero (if gravity is not important) or equal to the gravitational force      Surface forces: these arise from the stress exerted at the surface of the fluid parcel volume and can be computed by integrating the stress vector over the surface of the cube. Recall that the stress is composed of contributions from the pressure and the viscous contributions:    pressure: We calculate the force due to the pressure acting on the fluid in the cube. To simplify matters, we assume that the cube is small enough that the pressures can be taken as uniform over each of the faces. The component of the force in the -direction equals pressure times area on the left face minus that on the right face, that is , and since is small, this is approximately Note that this result is not entirely obvious, as we have not carefully integrated over the surface, rather we have just said that the force is pressure on the surface times area, without specifying at which point the pressure should be taken. Thus it is not immediately clear that the - and -components of the representative point in the expression are the same as those in the expression , and note that if these are not close enough, then wouldn't be true. Happily, with a bit more work (not included here), it can be shown that this is indeed the case.  Hence the pressure force on the fluid in the cuboid is This result is completely general, and shows that the pressure force per unit volume of the fluid equals which is a useful result in its own right.     viscous: For an incompressible Newtonian fluid the viscous forces are given by .         "
},
{
  "id": "fig-small-cube",
  "level": "2",
...
},
{
  ...
  "body": " Identities for plane polar coordinates  The conversion from polar coordinates and Cartesian is given by   The corresponding unit basis vectors are where the usual Cartesian basis vectors are and .  The gradient and curl operators are converted as   "
},
{
  "id": "backmatter-3",
  "level": "1",
