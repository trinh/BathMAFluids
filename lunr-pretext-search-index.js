...
},
{
  ...
  "number": "2.2.5",
  "title": "",
  "body": " Consider the unsteady flow given by . Plot the streamlines of the flow on the plane , and also the particle trajectories. What occurs with the streaklines?   In this case, the velocity field is changing in time. Consider firstly the concept of the streamline in .  We solve the governing equations for the streamlines , for fixed .  This gives for constants . Therefore the streamline are given by straight in the plane, if is fixed.  Consider instead the definition of particle paths via . We seek to solve yielding for constants . Therefore, we see that the particle paths are closed circles (in the -plane) of unit radius encircling the point .  In this case, considering the streakline via , we conclude that the streakline coincides with the particle path. Can you reason why this must be the case in this situation? What is necessary in order for this not to be true?   "
},
{
  "id": "ws-kinematics",
  "level": "1",
...
},
{
  ...
  "level": "2",
  "url": "ws-equations.html#ex-kelvin-circulation-theorem",
  "type": "Worksheet Exercise",
  "number": "3.6.6",
