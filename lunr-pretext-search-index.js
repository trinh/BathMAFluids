...
},
{
  ...
  "body": " A reminder of vector calculus   George Green's monumental work on electricity and magnetism, making use of many new concepts in vector calculus, 1828.   Cover    During the first week, we will provide a very brief review of some of the necessities that you may require in terms of vector calculus. Many of you will have taken the MA20223 Vector Calculus and Partial Differential Equations module, and a version of the 2026-27 lecture notes has been updated for easy reference on Moodle .  We will assume that you are familiar enough with how to interpret many of the vector calculus identities found in Sec. 10 of the University of Bath book of tables, which can be accessed on Moodle or via this link .  In general, over the next few weeks, you will want to be familiar with recalling\/looking up concepts like:   The use of identities like and . Some of these are found on p.24 of the above tables.    The notion of line integrals, surface integrals, and volume integrals.    The divergence theorem and Stokes' theorem. (p.24)    Conversion of vector operations and integrals into different coordinate systems (p.25)     "
},
{
  "id": "fig-intro-green",
  "level": "2",
...
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": " The reason the above derivatives are introduced is that, for the purpose of much of fluid dynamics, it is easier to work with Eulerian coordinates and quantities. However, for the purpose of deriving many governing equations, it turns out to be much easier to work with Lagrangian variables. This is because physical forces act on physical particles, or material elements, of the fluid.  "
},
{
...
},
{
  ...
  "body": " An oscillating hose\/plate   Water flows out of an oscillating hose, held along the edge , such that the velocity field produced is given by where and are constants.  Determine the streamline that passes through the origin at and .   Determine the pathline of the particle that was at the origin at ; at .  Qualitatively describe the shape of the streakline that passes through the origin?     Isolated pathlines show that particles move along straight paths.    gif     However, viewed in terms of the streakline, the visible pattern is oscillatory.    gif     "
},
{
  "id": "example-flux-surface",
  "level": "2",
  "url": "sec-flowexamples.html#example-flux-surface",
  "type": "Example",
  "number": "2.2.7",
  "title": "Flux through a surface.",
  "body": " Flux through a surface   Consider the velocity field . Let be the flat rectangular surface lying in the plane , with and , oriented with outward unit normal . Calculate the flux of through .    On the surface we have , so   The flux is therefore   Notice that only the -component of contributes, since points purely in the -direction; the flux measures how much fluid crosses per unit time in that direction.   "
},
{
  "id": "example-flux-curve",
  "level": "2",
  "url": "sec-flowexamples.html#example-flux-curve",
  "type": "Example",
  "number": "2.2.8",
  "title": "Flux through a curve.",
  "body": " Flux through a curve   Consider the uniform velocity field . Let be the straight line segment from to . Calculate the flux of through , taking the normal to point away from the origin.    The segment has length (a 3-4-5 triangle), and a unit tangent vector along is . Rotating by so that the resulting normal points away from the origin gives   Since is uniform, is constant along :   The flux is then this constant times the length of :   The main subtlety here is orientation: rotating the tangent the other way would have given and a flux of , correctly describing flow in the opposite sense across .   "
},
{
  "id": "example-total-force",
  "level": "2",
  "url": "sec-flowexamples.html#example-total-force",
  "type": "Example",
  "number": "2.2.9",
  "title": "Total force.",
  "body": " Total force   Suppose a pointwise force acts over the flat rectangular surface given by , , in the plane . Calculate the total force on .    Since lies in the plane , the area element is simply , and no normal vector is needed because is not dotted with anything in . We integrate each component of separately:   The total force is therefore   Unlike the two flux calculations above, the total force remains a vector: each Cartesian component of is integrated on its own.   "
},
{
  "id": "ws-kinematics",
  "level": "1",
...
{
  "id": "ex-hw-eulerian-lagrangian2",
  "level": "2",
  "url": "ws-kinematics.html#ex-hw-eulerian-lagrangian2",
  "type": "Exercise",
  "number": "2.3.4",
  "title": "Eulerian and Lagrangian descriptions.",
  "body": " Eulerian and Lagrangian descriptions   A fluid flows through the nozzle shown from to with one-dimensional velocity in the -direction, where and are constants. Note that, in reality the flow would be two- or three-dimensional, but we ignore this here for simplicity.   Sketch of nozzle.        What is the particle acceleration?           If a particle starts at at time , what is its position at time ?    We have Solving by separation of variables gives,       What is its Lagrangian velocity as a function of time?    The velocity is       What is its Lagrangian acceleration as a function of time?    The acceleration is       Write the Lagrangian velocity and acceleration as a function of . Compare with the corresponding Eulerian velocity and particle acceleration. What do you notice?    The velocity is as expected. This is the same as the Eulerian velocity at the particle position. The acceleration is which is the same as the particle acceleration, as expected from the definition.      How long does it take for a particle to travel from to ?    The particle reaches when     "
},
{
  "id": "ex-hw-particle-paths-streamlines",
  "level": "2",
  "url": "ws-kinematics.html#ex-hw-particle-paths-streamlines",
  "type": "Exercise",
  "number": "2.3.5",
...
{
  "id": "ex-hw-streamlines-pathlines-streaklines",
  "level": "2",
  "url": "ws-kinematics.html#ex-hw-streamlines-pathlines-streaklines",
  "type": "Exercise",
  "number": "2.3.6",
...
},
{
  ...
  "body": " Euler's identity   The material derivative of the Jacobian of the transformation is given by where .    The proof follows from direct differentiation of the determinant and use of the identity of the material derivative.   "
},
{
  "id": "thm-RTT",
  "level": "2",
...
},
{
  ...
  "body": " RTT and conserved quantities  Reynolds' Transport Theorem is particularly useful when the integral quantity is a conserved quantity . A conserved quantity is something for which we can apply a principle of conservation . In practice for this course, this is usually mass or linear momentum:   Mass: and the left-hand side of is zero because mass is conserved.    Linear momentum: is now a vector quantity and, by Newton's second law , the left-hand side of equals the sum of all the forces acting on the fluid in the control volume , which are:   Surface forces: Forces acting on the surfaces of the fluid, which could be reaction forces from the walls of a container, or forces due to pressure or stress from surrounding fluid. (Note that we will cover stress in .)    Body forces: Forces acting over the interior of the fluid, and in this course you will usually only need to consider the force of gravity, although in principle other body forces could act such as an electromagnetic force. In addition, if working in a non-inertial frame of reference, other apparent forces need to be added (forces due to linear acceleration, angular acceleration and the Coriolis and centrifugal forces).         "
},
{
...
},
{
  ...
  "body": " Leibniz's rule   The Reynolds' Transport Theorem , which relates to the passage of a time derivative through an integral, is a general form of the 1D Leibniz rule:      Examine the figure in . Can you associate the quantities in Leibniz's rule with the circled elements in the figure?   Visual \"proof\" of Leibniz's rule   Leibniz      The first circled element is associated with the quantity: This is essentially the finite-difference version of the first term on the RHS.  The second circled element is associated with the quantity: and is associated with the area of the rectangle.  The third circled element is associated with and is associated with the area of the rectangle. Notice that for small , the rectangle height of is approximately the same as the rectangle height of .      A nice proof of the Leibniz rule is given in this YouTube video by Brian Storey . Watch the video and follow the derivation, making your own notes.      Can you now connect the form of the rule in to the Reynolds' Transport Theorem in ?    Show that the Reynolds Transport Theorem in one dimension is equivalent to the Leibniz rule. Write the second and third terms on the RHS as     "
},
{
  "id": "ex-euler-check",
  "level": "2",
...
},
{
  ...
  "number": "4.1.2",
  "title": "Uniform flow.",
  "body": " Uniform flow  uniform flow  Consider the potential given by the linear function with constants and . Then by differentiation we have that the velocity is   The image shown below shows the streamlines of the flow.   Streamlines (or velocity field) of uniform flow with and .    "
},
{
...
},
{
  ...
  "body": " Cauchy-Riemann equations II   If two real-valued continuous functions, and of two real variables and have continuous first partial derivatives that satisfy the Cauchy-Riemann equations in some domain, then is analytic in that domain.    (Non-examinable)  The proof is not difficult, but we will refer students to for its proof. It relies on constructing the derivative of along any direction using the decomposition into the two Cartesian directions.   "
},
{
...
},
{
  ...
  "number": "4.21",
  "title": "",
  "body": " We now consider shifting the circle with to the left, so that the circumference passes through the critical point at . This produces an image that resembles an aerofoil with a sharp trailing edge.   Joukowski map   "
},
{
...
},
{
  ...
  "body": " Basic calculations   The following question relates to two-dimensional potential flow. Remember that the fluid flux through a surface given by contour is given by , or You will get some practice on calculating this quantity below.  We can also calculate the total force on the surface specified by by using the integral in . Since the force in potential flow is given by , then the total force is where is the pressure force given by Bernoulli's equation: and is a reference value and we ignore gravity.  For each of the following elementary flows, state or calculate:   the complex potential, ;    the velocity vector, written in vector form ;    the flux and fluid force on a surface consisting of a circle of unit radius;   Hint: the unit normal for the circle is ; when converting to polar coordinates remember that .    the flux and fluid force on a surface consisting of a plate given by the line with .        Uniform flow of velocity oriented at an angle of to the horizontal.    (i) complex potential given in the notes is ;  (ii) complex velocity is given by . Writing out the velocity components in vector form, we have   (iii) We expect the flux past a circle will be zero (since the flow will enter one side and exit the other). The flux is given by   The force is given by The total force again is zero since the force on the two hemispheres will cancel themselves out.  (iv) The normal of the plate is given by (here we assume this normal is pointing 'out'). We can parameterise the plate using a vector equation for the position vector: since the equation of the line is . Then So the surface conversion is The flux is then The above makes perfect sense. The fluid is entirely normal to the plate, and the plate has length .  For the force, remember that the pressure is constant, since the speed is constant. Thus       A line source of strength located at the origin.     Solution   The part about integrating the flux and forces for the little diagonal plate segment has some annoying integrals. You are not expected to obtain the final values of the integrals, but you will see in the next question that they can be predicted rather easily using a theorem about the streamfunctions.   Solution       Stagnation point flow with a stagnation point at the origin.     Solution   The integrals for the flux and force on the plate are less annoying than in the previous geometries, but again we have left the final force calculation un-evaluated (out of laziness).   Solution       A line vortex flow of strength placed at the origin.     Solution    Solution      "
},
{
...
},
{
  ...
  "number": "5.5",
  "title": "Exercises",
  "body": "  Derivation of the kinematic condition   In this question, you will derive the kinematic boundary condition on a free surface, which ensures that fluid particles on the free surface must remain on the free surface. Consider a vector that points to a location on a 2D free surface given by   Introduce the curve . For any particle on the surface, it must be the case that . By applying the material derivative show that the condition that for particles on the free surface is equivalent to the kinematic condition     By the definition of the material derivative, we have that Equating the above to zero for the case of yields the desired result.     Stokes waves in finite depth   Consider small 2D water waves on the free surface of a potential (incompressible and irrotational) fluid with velocity potential , with satisfying . Let the free surface be at and assume the water is confined above a flat channel of depth . Show that on the free surface, , the kinematic equation is given by while the dynamic (Bernouilli) equation is   Show that when the problem is linearised by ignoring quadratic terms, then instead the boundary conditions can be simplified to be and now applied on .  Show that travelling harmonic waves, with and , are possible and derive the associated dispersion relation,   In deriving the above, it will be convenient for you to use the hyperbolic cosine and sine functions: and note that the cosh function is even at (and therefore has a zero derivative). The use of hyperbolic functions is used in the solution of and is a common trick when solving boundary-value problems with exponentials.    Note that the finite-depth linear wave theory was derived as part of the problem class, so you can examine the video there for more details. Firstly, we look to linearise the two surface boundary conditions, which are imposed on . The quadratic terms can be ignored by assuming that the fluid is linearised about a small disturbance. Hence is assumed to be small. Similarly, the velocity terms are expanded about . For example, Thus we can approximate this quantity to leading order by   Therefore, both kinematic and dynamic conditions are simplified in this manner, yielding now imposed on .  We substitute now the ansatzes into the governing equations.  Written in terms of , we must now solve the following system:   Now instead of writing the solution for in terms of the two exponentials , it is better to write the general solution of the second-order ODE as where is constant. We can then see that if , then the boundary condition is satisfied.  The last two boundary conditions, evaluated on yield   For there to be non-trivial solutions, we thus need and therefore there are two possible wave speeds, namely and both are simply negatives of one another; so represent left and rightwards propagating waves of the same speed.     Linear waves in a current   We now consider linear waves in a channel of depth , as in the previous question. This time, however, assume that there is a uniform flow of speed at infinity.     Begin by writing down the boundary conditions that you expect at and also far upstream, with   Therefore, this time, we shall consider the velocity as expressed as and again linearise the necessary equations.    We begin with the governing equations as shown in .  On the channel bottom, we expect that the vertical velocity is zero, hence while at upstream infinity, we expect the the velocity to be uniform and of speed . Hence in terms of the potential,   Indeed, this suggests that we should linearise about the uniform flow, with where is the approximation, which we expect to be small (as is standard in linear problems, we often ignore the hat notation).      Linearise the associate free-surface equations, and show that this time, they produce and   When considering the second of the two equations above (Bernoilli's) return to the original Bernoulli equation: and choose your constant more strategically.    The linearisation process for the kinematic condition remains largely the same, except we would produce: Again quadratic terms are ignored, and we see that the requisite condition becomes (dropping the hat):   The linearisation of Bernoulli's equation is done similarly.  When considering the Bernoulli equation, it is prudent to take the choice of so that the inertial term is removed. Specifically, if we take this would remove the leading term from inertia.  The only difference with the usual linearisation process is the inertial term: so now Bernoulli's equation yields (dropping hats): where we have placed the boundary condition on as standard.      Show finally that the dispersion relation predicts possible waves of speeds   The regime where the flow speed is less than is known as subcritical. The regime where flow is greater than is supercritical. What can you anticipate about the waves in these two regimes based on the wave speeds above?    At this point, the linear solution follows similar steps to the case of finite depth with zero current. We have and .  Written in terms of , we must now solve the following system:   The first two equations yield the typical solution for the case of finite depth: The last two conditions yield   For there to be non-trivial solutions, we thus need and therefore there are two possible wave speeds, namely   In the deep water limit, if this yields subcritical solutions, and it is possible to have a wave pattern that is non-trivial upstream of the flow.       Fluids of different densities   Inviscid incompressible fluid of density lies in the region above a fluid with greater density for . Assume there there is a small-amplitude disturbance the two fluids with the surface given by . Assuming and the fluid velocities are small, assume that the linearised boundary conditions on the approximated boundary at are given by (Notice that these are three conditions; two kinematic conditions for the two fluids, and a dynamic (Bernoulli) condition).  If with , derive the dispersion relation     The kinematic condition(s) must be exactly the same form as the usual kinematic condition, since the density of the fluids play no role. They arise from setting for both fluids. This gives, after linearising, and as imposed on .  The dynamic condition expresses the fact that the pressures are equal at the interface between the two fluids. Therefore at the interface, we have (ignoring quadratic terms), from  However at the interface, we need the pressures to be equal. Therefore we can set . Subtracting the two equations then yields as applied on . We are free to pick the constants, so we pick them so as to completely zero the expression in the second group of brackets. Thus on .  So now the natural question is to ask how the linearisation procedure changes with the two fluids of different densities. Gain, we set and . The equation for is similarly given by and this time, we must select different exponential powers so as to ensure the fluid is bounded either as or as . This essentially yields for constants and .  The remaining boundary conditions are: thus which in matrix form is   Expanding the determinant about the first row yields which gives the desired result.     Fluids with surface tension   Suppose now that there is surface tension between the two fluids of . In lectures, it was shown that the linear dynamic boundary condition is given by consider the specific situation where the top fluid is air, with . Then the dynamic condition is and only need to consider the single potential .  The linear kinematic condition should be unchanged from the usual linear kinematic condition, on .  For the case of deep water waves, show that the frequency is now related to the wavenumber by the equation     This question was done in the problem class recording on 11 November 2025, accessed here .  Very little changes in the linearisation procedure with surface tension, as the only difference is the Bernoulli equation, which is linearised to give evaluated on .  Thus in this equation, we use the same ansatzes as for the previous few questions. The system of equations is   The derivation must be exactly the same as for infinite-depth gravity waves, and the only difference is that instead of , we can substitute when we impose the boundary conditions and apply the determinant condition.  Previously for deep-water gravity waves, we had . So now we must have as desired.     The dispersion relation (simple)   The following is a classic elementary demonstration of dispersive effects when considering the addition of two sinusoidals with two nearly-identical values of the wavenumber. It can be used to motivate the definition of group and phase velocities.  Consider two sinusoidal waves with nearly the same wavenumber and frequency:      Use the trig angle identity to put the wave into the form of a product of sinusoidal waves.           Consider now i.e. each wavenumber and frequency are centred about either or , respectively.  In the limit that (are small), argue that the wave consists of a rapidly oscillating waveform within a slowly-varying envelope.    Substituting these expressions, we have The point here is that , so the cosine term is very nearly 1. This yields the standard travelling sinusoidal wave. However, over long timescales, notably when is large, the cosine term is no longer constant. This yields a slowly varying envelope or amplitude multiplying the sine,      show that the envelope developed in the last part exhibits maxima as and therefore in the limit , the velocity of such maxima (called the group velocity) is given by     This part is quite straightforward. The maxima of the cosines are found at multiples of in the argument. For example, the first maxima lies at hence   This is indeed equivalent to a particle that moves with velocity . In the limit the perturbations to the quantities tends to zero, we can informally note that this leads to the notion of the group velocity,      "
},
{
...
{
  "id": "navier-stokes-continuity-cylindrical",
  "level": "2",
  "url": "sec-linear-momentum-cons.html#navier-stokes-continuity-cylindrical",
  "type": "Remark",
  "number": "6.5.10",
  "title": "Navier–Stokes and continuity equations in cylindrical coordinates.",
  "body": " Navier Stokes and continuity equations in cylindrical coordinates  In cylindrical coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid. In the case of gravity we set , where is the acceleration due to gravity.  Note that the vector calculus operators in cylindrical (and also in spherical) coordinates are quite complicated. I would always recommend looking up the formulae, because they is very tricky to remember and extremely time-consuming to derive. A helpful website that lists these formulae along with many other useful formulae is here , and gives these formulae in the appendices, as do many other textbooks. Note in particular that the Laplacian of a vector quantity is not given by the Laplacians of its components individually.  "
},
{
  "id": "navier-stokes-continuity-spherical",
  "level": "2",
  "url": "sec-linear-momentum-cons.html#navier-stokes-continuity-spherical",
  "type": "Remark",
  "number": "6.5.11",
  "title": "Navier–Stokes and continuity equations in spherical coordinates.",
  "body": " Navier Stokes and continuity equations in spherical coordinates  In spherical coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid. Again in the case of gravity we set , where .  "
},
{
...
{
  "id": "sec-viscous-dissipation-of-energy",
  "level": "1",
  "url": "sec-viscous-dissipation-of-energy.html",
  "type": "Section",
  "number": "6.6",
  "title": "Viscous Dissipation of Energy",
  "body": " Viscous Dissipation of Energy   Non-examinable.   In this section we derive an expression for the rate of dissipation of kinetic energy in terms of the rate-of-strain tensor.  We consider a volume of fluid moving with the fluid. The total kinetic energy in is    Viscous dissipation of energy   For an incompressible Newtonian fluid and a volume of the fluid with surface , which both move with the fluid, the rate of change of kinetic energy equals where is the rate of dissipation per unit volume due to the viscous stresses.     We need derive an expression for the rate of change: Using the Cauchy equation : where, in the above calculation, we used the divergence theorem to obtain the penultimate line and the definition of stress to obtain the fourth line. We need to simplify where in the first line of the above we used the fact that is symmetric, in the second line we swapped the and indices on the second term, in the third line we used the constitutive relationship for a Newtonian fluid , and in the final line we used the fact that the divergence of is zero due to mass conservaion.  Hence, and the result follows.    Interpretation of the terms in the viscous dissipation  The terms on the right-hand side of have physical interpretations as follows:   The first term is the decrease in gravitational potential energy associated with the flow. This energy is converted into kinetic energy.    The second term equals the rate at which the surrounding fluid is doing work on the fluid in via the surface stresses .    Throughout the volume of fluid, the viscous stresses act to reduce the energy, so this term is integrated over the volume.       Viscous stresses  Recall from that any incompressible flow may locally be written as a sum of a translation, a rotation and a straining component. The viscous stresses are zero for the translational and rotational components of the flow and non-zero for the straining component.  Since the rate-of-strain tensor is symmetric, and writing where is symmetric, we have where , , are the eigenvalues of .    The energy equation  We can also use the Reynolds Transport Theorem to perform conservation of energy in the control volume instead of mass. The energy is the sum of the internal energy, kinetic energy and the gravitational potential energy where is the internal energy per unit mass (which is often expressed as ) and is the acceleration due to gravity.  In the special case that the fluid is incompressible and Newtonian and that the specific heat is constant and the fluid is homogeneous and isotropic, and, upon letting the volume of the control volume tend to zero, we obtain where    is the specific heat at constant volume, which is the rate of change of internal energy of the fluid with respect to temperature,     is the temperature of the fluid,     is the coefficient of thermal conductivity, which is the heat flux per unit area per unit temperature gradient (by Fourier's law, which is , where is the flux of heat per unit area cf Fick's law), and     is the rate of heating due to viscous stresses.     is the energy production per unit volume per unit time.   This is the diffusion equation with an extra term, , representing the heating due to viscous stresses in the fluid. It is the energy loss due to the viscous forces per unit volume of fluid per unit time. Often this term is neglected to give the usual advection--diffusion equation. In a non-Newtonian fluid the equation is significantly more complicated.   "
},
{
  "id": "thm-viscous-dissipation",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#thm-viscous-dissipation",
  "type": "Theorem",
  "number": "6.6.1",
  "title": "Viscous dissipation of energy.",
  "body": " Viscous dissipation of energy   For an incompressible Newtonian fluid and a volume of the fluid with surface , which both move with the fluid, the rate of change of kinetic energy equals where is the rate of dissipation per unit volume due to the viscous stresses.   "
},
{
  "id": "sec-viscous-dissipation-of-energy-6",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-6",
  "type": "Proof",
  "number": "6.6.1",
  "title": "",
  "body": " We need derive an expression for the rate of change: Using the Cauchy equation : where, in the above calculation, we used the divergence theorem to obtain the penultimate line and the definition of stress to obtain the fourth line. We need to simplify where in the first line of the above we used the fact that is symmetric, in the second line we swapped the and indices on the second term, in the third line we used the constitutive relationship for a Newtonian fluid , and in the final line we used the fact that the divergence of is zero due to mass conservaion.  Hence, and the result follows.  "
},
{
  "id": "sec-viscous-dissipation-of-energy-7",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-7",
  "type": "Remark",
  "number": "6.6.2",
  "title": "Interpretation of the terms in the viscous dissipation.",
  "body": " Interpretation of the terms in the viscous dissipation  The terms on the right-hand side of have physical interpretations as follows:   The first term is the decrease in gravitational potential energy associated with the flow. This energy is converted into kinetic energy.    The second term equals the rate at which the surrounding fluid is doing work on the fluid in via the surface stresses .    Throughout the volume of fluid, the viscous stresses act to reduce the energy, so this term is integrated over the volume.     "
},
{
  "id": "sec-viscous-dissipation-of-energy-8",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-8",
  "type": "Remark",
  "number": "6.6.3",
  "title": "Viscous stresses.",
  "body": " Viscous stresses  Recall from that any incompressible flow may locally be written as a sum of a translation, a rotation and a straining component. The viscous stresses are zero for the translational and rotational components of the flow and non-zero for the straining component.  Since the rate-of-strain tensor is symmetric, and writing where is symmetric, we have where , , are the eigenvalues of .  "
},
{
  "id": "sec-viscous-dissipation-of-energy-9",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-9",
  "type": "Remark",
  "number": "6.6.4",
  "title": "The energy equation.",
  "body": " The energy equation  We can also use the Reynolds Transport Theorem to perform conservation of energy in the control volume instead of mass. The energy is the sum of the internal energy, kinetic energy and the gravitational potential energy where is the internal energy per unit mass (which is often expressed as ) and is the acceleration due to gravity.  In the special case that the fluid is incompressible and Newtonian and that the specific heat is constant and the fluid is homogeneous and isotropic, and, upon letting the volume of the control volume tend to zero, we obtain where    is the specific heat at constant volume, which is the rate of change of internal energy of the fluid with respect to temperature,     is the temperature of the fluid,     is the coefficient of thermal conductivity, which is the heat flux per unit area per unit temperature gradient (by Fourier's law, which is , where is the flux of heat per unit area cf Fick's law), and     is the rate of heating due to viscous stresses.     is the energy production per unit volume per unit time.   This is the diffusion equation with an extra term, , representing the heating due to viscous stresses in the fluid. It is the energy loss due to the viscous forces per unit volume of fluid per unit time. Often this term is neglected to give the usual advection--diffusion equation. In a non-Newtonian fluid the equation is significantly more complicated.  "
},
{
  "id": "sec-methods-to-solve-equations",
  "level": "1",
  "url": "sec-methods-to-solve-equations.html",
  "type": "Section",
  "number": "6.7",
  "title": "Methods to solve the Navier–Stokes and continuity equations",
  "body": " Methods to solve the Navier Stokes and continuity equations   Methods of solution  For real problems, it is notoriously difficult to solve the Navier Stokes and continuity equations. Many researchers spend their entire careers analysing and solving these very equations! In practical terms, a variety of analytical and numerical techniques must be employed, and usually we only get an approximate solution. In this course we are only looking at analytical approaches, but you should be aware that there are many different approaches possible, and we describe a few in the following:     A few problems in fluid mechanics have analytical solutions, meaning they can be solved exactly. For example the solution for Poiseuille flow in a pipe is exact, and has proved to be an excellent description of steady flow in a pipe, even in realistic, imperfect conditions.    Other problems can be solved in the form of an infinite series. An example of this is boundary layer theory or lubrication theory, in which we choose a small parameter (which is a dimensionless quantity with a physical meaning). For example, it could be that two lengthscales in the problem are very different from one another, and we choose equal to the smaller lengthscale divided by the large one. We write the solution as an infinite series of terms, for example where the dots indicate terms multiplied by higher powers of (that is, smaller terms). Examples include:   flow in a curved pipe for small Dean numbers (proportional to the Reynolds number times the square root of the curvature of the pipe),    flow of a thin film of fluid. We take equal to a typical film thickness divided by a typical lengthscale tangential to the film. Often, it is sufficient to compute only the leading nontrivial terms in the series, and the equations governing these terms represent a hugh simplification over the Navier Stokes and continuity equations. Whilst the resulting equations generally need to be solved numerically, the spatial dimension of the problem is reduced by one for such flows, and this is a huge saving of computational time.       Other problems can be solved approximately by neglecting terms that are known to be small. An example of this is high-Reynolds-number flow when we can solve the Euler equations and low-Reynolds-number flow when we can solve the Stokes equations instead of the full Navier Stokes equations. Flow in a porous medium (such as flow of water through soil, oil through porous rocks or tissue fluid between cells in the body) is a different type of approximation in which we only consider average flow variables. This approximation is a simplification of the solution in the form of an infinite series, and effectively, we are just finding the first term of the infinite series, that is we are finding and from the series solutions given above.    In many cases, we cannot solve the equations analytically, but we can find a solution by simulating them on a computer.    In other cases we need to simplify the equations somewhat to solve them on a computer. An example is if there are sharp boundary layers, which need fine resolution for the solution to be found there.    Finally, one can use an experimental approach, either by building a scale model, which should have dimensionless parameters such as the Reynolds number the same as the original, or by taking measurements on the original system. The big advantage is that, as long as the experiment is correctly performed, the flows should be realistic of the system being studied, but the disadvantages are that it is often hard to perform measurements of flow and pressure with sufficient accuracy or resolution.       Methods to solve the equations analytically  We start by looking at the special cases in which we can solve the equations analytically. In these cases, we typically first make some simplifying assumptions. Note that for these types of problems, we are only trying to find a solution that works (proving the uniqueness of the solutions we find is a much harder thing to do i.e. it is hard to prove that the solution we found is the only one).   Stability: Whether or not a given solution that we find is stable is a crucial question, because if it is not stable then it would not be seen in an experiment. To determine stability mathematically we would need to use techniques such as those taught in the course MA40045 Dynamical Systems. However, it is typically very difficult to do this in practice in the study of fluid dynamics because of the (infinite) dimensionality of the phase space. The methods we use in this course to find exact solutions that is, making assumptions and finding a solution to the equations get us a solution, but don't know whether or not it is stable. A practical way of determining stability is to perform an experiment or numerical simulation (which is sometimes called a numerical experiment) an unstable solution would not be able to be found this way, but these methods can be difficult if it is only very weakly unstable. Plus part of the reason for finding analytical solutions is to avoid having to do experiments or numerics, which are often much more time-consuming and difficult!   Simplifying a problem by making assumptions: When considering a problem that involves solving the Navier Stokes and continuity equations, we often make one or more (in fact as many as possible!) of the following simplifying assumptions:    Two-dimensional flow (in -plane):  (indeed for any variable) and . Of course, this can be generalised to two-dimensional flow in the - or -planes and also two-dimensional flow in the -directions in cylindrical polar coordinates. For example we may do a lab experiment between closely separated parallel plates to ensure that the flow is approximately two-dimensional (Hele Shaw cell).     One-dimensional flow (in -direction):  and and . This can be generalised to any direction. For example, blood flow in arteries has been successfully analysed using a one-dimensional approach in which the changes in flow and pressure that happen during a cardiac cycle can be seen as waves that travel around the body with a characteristic wave speed (that is different from the blood velocity).     Independence of a coordinate: For example if nothing in the problem depends on and there is no reason to assume that anything should depend on .  We used this for the Stokes boundary layer problem .     Axisymmetric flow:  (indeed for all variables) and . In addition, if there is a symmetry in a plane that includes the axis the This can alternatively be written in spherical coordinates (in which case and ).     Rotationally symmetric flow:  (indeed for all variables) but is not necesarily zero. For example a line vortex is rotationally symmetric but not axisymmetric. We can similarly write Problems of this sort can also be written in spherical coordinates (in which case ).     Spherically symmetric flow:  and and .     Steady flow:  (indeed for any variable).  Many examples that we cover make this assumption.     Fully developed flow:  , but is not, in general, zero.  The pipe flow problem, Poiseuille flow uses this assumption.     Periodic and sinusoidal flow (with period ):  where the angular frequency .  This assumption will be made in the Stokes boundary layer example .   Most of these are assumptions on the geometry and spatial symmetries of the problem, but the assumptions of steady flow, fully developed flow and periodic and sinusoidal flow are different. The trick is to look carefully at the problem, and think which (if any) of the above assumptions might be reasonable. We can try making them, and then check that the problem is still consistent. If it is consistent that is fine, but if not it means that the assumption was wrong.   "
},
{
  "id": "sec-exact-solutions",
  "level": "1",
  "url": "sec-exact-solutions.html",
  "type": "Section",
  "number": "6.8",
  "title": "Examples of solutions to the Navier–Stokes equations",
  "body": " Examples of solutions to the Navier Stokes equations  There is a remarkably small number of types of exact solutions to the Navier Stokes and continuity equations. A particular reason for this is the nonlinear term , which makes it difficult to find mathematically exact solutions, and indeed, many of the known exact solutions have , thus removing the problem of the nonlinear term. In this section, we present a few of the more well known exact solutions. N.B. In all of the examples in this section we neglect gravity.   Shear flow  Shear flow often occurs near a rigid flat surface, and has the following properties:   The flow is unidirectional and parallel to the surface.    The flow speed increases linearly as we move away from the surface.   For example if the surface is the plane , then the flow is a shear flow, where is constant, see .   Sketch of shear flow velocity profile.    To check this is a solution of the Navier Stokes and continuity equations, we substitute in the expressions. The continuity equation is readily satisfied, whilst the Navier Stokes equations give and thus is constant everywhere in space.  For a Newtonian fluid contained between parallel plates moving tangentially, we obtain a shear flow in the gap. The velocity varies linearly across the gap and matches the plate velocity at each of the two plates. This is called Couette flow and it is an exact solution of the Navier Stokes and continuity equations:    : The flow is steady so this term is zero.     : Since is directed tangential to the plates, is a derivative in the tangential direction; however, varies only in the direction normal to the plates. Therefore, is zero for this flow.     : The pressure is uniform, so this term is zero.     : The flow has a linear profile so is zero.     : The flow only varies in the direction normal to the plates and the normal component of the velocity is zero, meaning that this term is zero.      Shear flow would be generated under the block.      Hagen Poiseuille flow (or Poiseuille flow)  Poiseuille flow is the characteristic flow seen when an incompressible Newtonian fluid flows steadily along a cylindrical pipe whose length is long compared with its diameter. To find the fluid velocity we use cylindrical polar coordinates , and assume that the pipe wall is at . We denote the fluid velocity components as in the three coordinate directions, i.e. , and assume a no-slip boundary condition at the pipe wall: We also assume that the flow is steady, is axisymmetric, has no swirl (i.e.no azimuthal flow), is fully-developed, and we neglect gravity.   Steady flow:     Axisymmetric flow:     No swirl:     Fully-developed flow means the fluid velocity doesn't change as we move along the pipe (we ignore end effects since the pipe length is long compared to the diameter), and also that the axial pressure gradient is constant, i.e.      Since the fluid is incompressible and Newtonian we take as our starting point the Navier Stokes and continuity equations in cylindrical polar coordinates . The continuity equation is and applying assumptions 2 (or 3) and 4 in the list above, we get where is constant. Applying the boundary conditions gives , and therefore , so the velocity is axial .  Neglecting time-dependence and gravity, the Navier Stokes equations are: We take the terms individually:   Since , and this equals zero by the fully developed assumption (4 above).    The pressure gradient equals     Since the - and -derivatives of vanish, Note that the formula used here for is standard and can be looked up (so you don't need to remember it, though you should be aware that the gradient operator takes a different form in polar coordinates).   Thus the three components of the Navier Stokes equation are    -component:      -component:      -component:    Solving the -component gives the axial velocity component : We require for regularity of the solution at , and since the boundary condition has at , we must set . Therefore the fluid velocity in Poiseuille flow is given by which is illustrated in .   Sketch of Poiseuille flow velocity profile.    The celebrated Hagen Poiseuille formula can be derived from : This relates the volumetric flux and pressure drop along a circular pipe of length and radius in a Newtonian fluid with shear viscosity for steady, fully developed flow. You will derive this result in .  We now consider two generalisations:    Womersley flow: This is pipe flow driven by an axial pressure drop along the pipe that oscillates sinusoidally in time (Poiseuille flow was driven by a constant pressure gradient). Unlike Poiseuille flow, the exact profile of the flow depends on a parameter called the Womersley parameter (which depends on the frequency). shows an example. The flow is:   Unidirectional axial flow (purely along the pipe)    Axisymmetric    Flow direction oscillates in time. Sometimes the flow goes in both directions at once, which can be seen in .   If we add the velocity field of Poiseuille flow onto the Womersley flow velocity field, we obtain the flow that would be driven by a pressure gradient that oscillates about a non-zero mean. Flow profiles of this sort can be seen in blood flow, since the beating of the heart provides a pressure gradient that can be approximated by a constant plus sinusoidally varying component.     Dean flow: This is a steady flow driven by a steady prescribed pressure drop along the pipe, but the pipe is curved, see . Within the pipe the flow is predominantly in the axial direction, but the centrifugal force due to the curvature drives a secondary flow across the centre of the pipe towards the outside of the bend, and then back around the walls of the pipe towards the inside of the bend. This secondary flow forms Dean vortices. This is thought to provide a possible explanation as to why the disease atherosclerosis in arteries is more common on the inside of bends in arteries, since the cells lining the artery walls are more healthy in conditions of high stress. shows shows the secondary flow in the transverse cross section, which are termed Dean vortices .      Sketch of Womersley flow velocity profile.     Sketch of Dean flow velocity profile: (a) longitudinal cross-section; (b) transverse cross-section.      Channel flow  This is the characteristic flow seen between two fixed parallel plates driven by a steady pressure gradient. The assumptions are:   Parallel fixed plates    Two-dimensional flow    Steady flow    Fully developed flow   The resulting profile is shown in . The flow is parabolic and looks similar to a cross-section of Poiseuille flow. See also the cartoon of channel flow between two plates.   Sketch of channel flow velocity profile.      Axisymmetric Couette flow  This is the characteristic flow that is observed between cylinders that are rotating relative to one another. We assume:   Coaxial cylinders, rotating at different constant angular velocities    Two-dimensional flow (no dependence on -coordinate)    Axisymmetric flow    Steady flow   The resulting flow is illustrated in .   Sketch of axisymmetric Couette flow.      Stokes boundary layer    Sketch of set up for Stokes boundary layer.    In this question you will investigate the flow field generated next to a flat oscillating plate. Assume that the plate is at with an incompressible Newtonian fluid of density and kinematic viscosity in , and that the plate oscillates purely in the -direction with displacement at time , as shown in . You may also assume that the plate and volume of fluid are large enough that you can neglect their boundaries (that is, the plate occupies the whole plane and the fluid occupies the whole of ) and that the plate has been oscillating long enough so that the whole fluid is oscillating periodically.     Write down the equations and boundary conditions governing the flow.    The fluid is governed by the Navier Stokes and continuity equations: At the boundary conditions are       Write down assumptions about the components of the fluid flow and their dependence on the spatial coordinates , and . Use this to simplify the the governing equations and boundary conditions.    We assume this is a two-dimensional flow, with and all components not depending on . In addition we assume the velocity components do not depend on (because translating the problem in the -direction is the same problem). Thus we have , , and .  The continuity equation is The first and third terms are zero by assumption, and therefore Hence is constant, and the boundary condition at implies that everywhere. The three components of the Navier Stokes equation simplify to Thus is constant in space and the only non-trivial equation is together with boundary conditions at .      Make the assumption that the flow and pressure are sinusoidal, that is and . Use this to simplify and solve the governing equations to find the velocity field.    The periodic assumption simplifies to (the other components are not needed). Substituting into the governing equation, The coefficients of must balance and the coefficients of must balance. Therefore These two equations are the complex conjugates of one another, so we only need to solve one of them, which gives the general solution The function as , and thus . The boundary condition at . Hence , meaning that . Hence       Sketch the velocity profile at time .    The velocity profile is a sinusoidal function whose amplitude decays exponentially with the distance from the surface.   Stokes boundary layer flow.    This is a famous exact solution of the Navier Stokes equations, and the flow we have found here is characteristic of the flow that exists near an oscillating boundary. Note that the flow decays away from the wall, and for this reason it is often described as a boundary later, and the solution is called Stokes boundary layer flow.      Low-Reynolds-number flow past a sphere (non-examinable)  This section is non-examinable.   Photographs of a sphere moving through a fluid with . The top photograph is in the reference frame in which the sphere is stationary, and the bottom photograph is in a fixed frame, (note the shadow cast by the sphere is not indicative of the flow). Taken from , and see also Figs. 25, 51, 56, 58 from this book, which show the flow for higher Reynolds numbers.     Sketches of the flow field around of a fixed sphere in a moving fluid for (a) low, (b) moderate and (c) high Reynolds numbers.    In this section we find the flow around a sphere moving through a fluid at a low Reynolds number, using a Stokes streamfunction. We use this to find the drag on the sphere. shows two photographs of the same flow, but visualised in two different ways, and shows sketches of the flow for a range of Reynolds numbers.  The calculation shows that the drag force experienced by an object moving through a fluid at low Reynolds numbers can be derived from the Stokes equations. This analysis shows that the Stokes drag on a sphere is in the direction opposing motion, which holds as long as . This is a famous classical result in fluid mechanics.  This principle is used in a falling ball viscometer in which a small spherical ball of known radius and mass is dropped into a fluid, whose viscosity we wish to measure. Once the ball has reached its terminal falling velocity , the forces on it must be in equilibrium, meaning that the force of gravity balances the drag force. Assuming the sphere is small enough and going slowly enough and the fluid is viscous enough that the flow has a low Reynolds number, the drag is given by and the force of gravity is , where is the acceleration due to gravity. Thus and so measuring the terminal velocity and substituting into this equation gives an estimate of the viscosity of the fluid.  We assume the flow is axisymmetric and work in a moving reference frame centred on the sphere using spherical coordinates. As shown in , we can write the velocity in terms of a Stokes streamfunction using : From , the vorticity is given by where the differential operator is a variant of the Laplacian operator, defined by its action on a function by At low Reynolds numbers, we take the curl of the Stokes equation to give and, after some work, we may show this is equivalent to We need boundary conditions on , which are given by the following:   No-slip conditions on the surface of the sphere ( ). Using the expressions for and above, these become     As we must have uniform flow with velocity in the direction . Using the expressions for the velocity components and above, these become Combining these we get where is constant. Adding a constant onto the streamfunction does not affect the velocity, and thus we may arbitrarily set , giving    Thus we have to solve subject to the on and as . We try a separable function and the condition implies that (or a multiple thereof). Substituting into and using , after some algebra we obtain We try and obtain Thus or , and so the general solution of is    Enforcing the behaviour as , we need , and so , . Thus     Applying the boundary condition at , which must be true for all values of . Thus     Applying the boundary condition at , which must be true for all . Thus    Equations and have the solution and . Thus and we can substitute this into the expressions for the components of the velocity field to obtain the velocity:   We can also find the pressure using the Stokes equation in the form . After a lot of algebra we obtain which we solve to find where is constant.  Perhaps the most interesting application of this solution is to find the drag on the sphere, which is the total force of the fluid on the sphere, retarding the motion. Since the stress is the force per unit area on the sphere, the drag equals the integral of the stress over the surface. We find the stress using We use the expression for in spherical polar coordinates , and then gives the stress on the surface as On substituting in the expressions for the velocity components , , , we find that We express the bracket in this equation in terms of Cartesian coordinates, using the conversion formulae Substituting this into the expression for , we obtain the stress The drag equals the integral of over the surface of the sphere. The integral of the term is zero because this force cancels on opposite sides of the sphere, but the term is always in the same direction; thus the total drag force is this term times the area, which is Thus the drag force is in the direction opposing motion. This is called the Stokes drag and it is a famous result in fluid mechanics.   This derivation is extremely complicated in terms of the algebra, and you would certainly not be asked to reproduce something so long-winded as this in this course. However, you should understand the concepts, and be able to follow the general argument. In fact the mathematics presented here is very elegant indeed, and it is amazing that an exact solution exists and can be calculated.    Notice that in the course of the derivation , we made the assumption that is separable. Thus we have not rigorously shown that the solution we found was unique, that is there might be other solutions to this problem that satisfy the boundary conditions at and the condition as .    This solution is the same as the irrotational flow solution (see ). Note that for any real fluid (i.e. one with viscosity), this solution would only be seen for low Reynolds numbers, despite the fact that inviscid fluids correspond to high Reynolds numbers.     Womersley flow (non-examinable)   This section is non-examinable.   Womersley flow occurs in pipes in which there is an imposed oscillating pressure gradient. Characteristics of this flow are often seen in blood flow in arteries, since the flow and pressure gradient are unsteady. As for the derivation of Poiseuille flow, we consider a long, circular cylindrical pipe of radius , and work in cylindrical polar coordinates centred on the axis of the pipe. We make the following assumptions:   The flow is fully developed ; thus .    The flow is axisymmetric ; thus .    The flow has a symmetry in a diameter of the cross-section. In turn this means there is no swirl in the flow, and thus .   The derivation proceed similarly to that of Poiseuille flow (so we cover it quite briefly here). With the assumptions, the continuity equation reduces to which gives , whereupon the boundary condition implies that the constant of proportionality is zero, and hence . Thus the only flow component is the axial flow, , which, according to the assumptions, is a function of and only (and does not depend on either or ). The radial and azimuthal components of the Navier Stokes equation reduce to the equations and thus is a function of and only. The axial component of the Navier Stokes equation is Consider what happens to the three terms in this equation at fixed values of and as alone is varied. Since is not a function of , the only term that can vary is , while the other two terms stay constant. Since equality must be maintained this shows that, in fact, must be fixed as varies, and thus , where and are unknown functions of time. We set to be the pressure gradient of the flow at time .  In Poiseuille flow is fixed in time, but in Womersley flow we set , where is constant (by fixing the origin of time we may fix to be real and positive). We can write this as where denotes the complex conjugate. We try a solution of the form where is a complex-valued function, and, substituting this into , we obtain This equation must be true for all values of , which means that both of the expressions in brackets must be be zero. Since the two bracketed expressions are complex conjugates of one another, we only need to consider the first bracket. Thus This is a linear, second-order, non-constant-coefficient, non-homogeneous ordinary differential equation for . We can therefore solve it as a complementary function plus a particular integral . The particular integral is given by To find the complementary function we must solve and substituting and simplifying, we remove the coefficients on the left-hand side to obtain This equation is the standard form of a special equation called Bessel's equation. The two linearly independent solutions are called Bessel functions of order zero, and they are denoted and , see and .   Bessel functions of the first kind , and (from Wikipedia entry on Bessel functions).     Bessel functions of the second kind , and (from Wikipedia entry on Bessel functions).    We therefore obtain the complementary function where and are constants of integration, and thus where the Womersley number is a dimensionless parameter defined by To find the constants and we apply the boundary conditions and regularity conditions at the origin (as we did for Poiseuille flow):   At : The function tends to infinity as and so contributions from are not allowed, meaning that must be set to zero.    At : The no-slip boundary condition is at the wall for all times, which from means that must also be zero at . Substituting into the solution for gives    Hence and, substituting this into , we get This is Womersley flow, which was first described by Womersley in 1955. The nondimensionalised flow profile is where , , . This nondimensionalisation shows that the flow is characterised by a single parameter, the Womersley number, (as opposed to 4 dimensional parameters: , , and ). Sketches of the flow profiles for different values of are given in Figure~\\ref{fig:womersley} and some movies will be shown in the lecture.   Snapshots of sketches of Womersley flow profiles for various Womersley numbers. (a) Low Womersley number (profile is Poiseuille flow multiplied by a time-dependent factor), (b) intermediate Womersley number, (c) high Womersley number (profile is flat across the interior with a boundary layer in which the flow oscillates rapidly).     We may do a similar analysis for any prescribed periodic pressure gradient . To do this we decompose into a Fourier series sum of terms of different frequencies. We solve for the flow generated by each component of individually. The total flow is the sum of these flow components.    In the human arterial system the Womersley number of the fundamental harmonic is different in different arteries and it takes values up to about 20.    For small Womersley numbers we use the Taylor series expansion of the Bessel function: to find an approximation of . which is a Poiseuille flow profile (multiplied by an oscillating amplitude). This flow is called quasi-steady , because this is the solution that we would obtain if we neglected the time-derivative term in the Navier Stokes equation.    For large Womersley numbers we use the standard asymptotic expansions for the Bessel function, which is: when . Letting , where and are real, we can expand the cosine function: where the second approximation is valid if (which is the case we have). Substituting into , we obtain Away from the boundaries, is large and so the exponential terms in the bracket in this expression are very small, and This type of flow is called plug flow , since at any fixed time the profile is uniform across the interior.  Near the walls of the pipe the exponential terms become important. At the walls themselves, the flow is zero, and, as we move away, the expression for the velocity shows there are rapid oscillations that decrease in magnitude as we move away from the wall.  Thus we see that the flow is divided into two distinct regions. There is the core in which the dominant balance is between the pressure gradient and the inertial term (the time-derivative term), and in which the viscosity plays a minor role. Sometimes this is termed an inviscid core . The other region is the boundary layer, in which the viscosity is important. The width of the boundary layer is of the order of magnitude (often we would just say loosely that the boundary layer has width ). Within a few 's away from the boundary, the flow is affected by the presence of the boundary, but further away the effect is negligible.  Another way that we could find the flow for large Womersley number is to use boundary layer analysis in the boundary, and an inviscid flow method (such as potential flow analysis) in the interior, and match the two solutions at the edge of the boundary layer. Since we have the exact solution valid for all Womersley numbers, this method of separating into the boundary layer and core regions is not necessary to find the solution. However, in many problems, no solution can be found in the general case, but a solution can be found in the particular case when one parameter is large or small. It is surprising how often such solutions are possible in real world problems, and this method often provides significant insight into the problem.    "
},
{
  "id": "subsec-shear-flow",
  "level": "2",
  "url": "sec-exact-solutions.html#subsec-shear-flow",
  "type": "Example",
  "number": "6.8.1",
  "title": "Shear flow.",
  "body": " Shear flow  Shear flow often occurs near a rigid flat surface, and has the following properties:   The flow is unidirectional and parallel to the surface.    The flow speed increases linearly as we move away from the surface.   For example if the surface is the plane , then the flow is a shear flow, where is constant, see .   Sketch of shear flow velocity profile.    To check this is a solution of the Navier Stokes and continuity equations, we substitute in the expressions. The continuity equation is readily satisfied, whilst the Navier Stokes equations give and thus is constant everywhere in space.  For a Newtonian fluid contained between parallel plates moving tangentially, we obtain a shear flow in the gap. The velocity varies linearly across the gap and matches the plate velocity at each of the two plates. This is called Couette flow and it is an exact solution of the Navier Stokes and continuity equations:    : The flow is steady so this term is zero.     : Since is directed tangential to the plates, is a derivative in the tangential direction; however, varies only in the direction normal to the plates. Therefore, is zero for this flow.     : The pressure is uniform, so this term is zero.     : The flow has a linear profile so is zero.     : The flow only varies in the direction normal to the plates and the normal component of the velocity is zero, meaning that this term is zero.      Shear flow would be generated under the block.    "
},
{
  "id": "sec-poiseuille",
  "level": "2",
  "url": "sec-exact-solutions.html#sec-poiseuille",
  "type": "Example",
  "number": "6.8.2",
  "title": "Hagen–Poiseuille flow (or Poiseuille flow).",
  "body": " Hagen Poiseuille flow (or Poiseuille flow)  Poiseuille flow is the characteristic flow seen when an incompressible Newtonian fluid flows steadily along a cylindrical pipe whose length is long compared with its diameter. To find the fluid velocity we use cylindrical polar coordinates , and assume that the pipe wall is at . We denote the fluid velocity components as in the three coordinate directions, i.e. , and assume a no-slip boundary condition at the pipe wall: We also assume that the flow is steady, is axisymmetric, has no swirl (i.e.no azimuthal flow), is fully-developed, and we neglect gravity.   Steady flow:     Axisymmetric flow:     No swirl:     Fully-developed flow means the fluid velocity doesn't change as we move along the pipe (we ignore end effects since the pipe length is long compared to the diameter), and also that the axial pressure gradient is constant, i.e.      Since the fluid is incompressible and Newtonian we take as our starting point the Navier Stokes and continuity equations in cylindrical polar coordinates . The continuity equation is and applying assumptions 2 (or 3) and 4 in the list above, we get where is constant. Applying the boundary conditions gives , and therefore , so the velocity is axial .  Neglecting time-dependence and gravity, the Navier Stokes equations are: We take the terms individually:   Since , and this equals zero by the fully developed assumption (4 above).    The pressure gradient equals     Since the - and -derivatives of vanish, Note that the formula used here for is standard and can be looked up (so you don't need to remember it, though you should be aware that the gradient operator takes a different form in polar coordinates).   Thus the three components of the Navier Stokes equation are    -component:      -component:      -component:    Solving the -component gives the axial velocity component : We require for regularity of the solution at , and since the boundary condition has at , we must set . Therefore the fluid velocity in Poiseuille flow is given by which is illustrated in .   Sketch of Poiseuille flow velocity profile.    The celebrated Hagen Poiseuille formula can be derived from : This relates the volumetric flux and pressure drop along a circular pipe of length and radius in a Newtonian fluid with shear viscosity for steady, fully developed flow. You will derive this result in .  We now consider two generalisations:    Womersley flow: This is pipe flow driven by an axial pressure drop along the pipe that oscillates sinusoidally in time (Poiseuille flow was driven by a constant pressure gradient). Unlike Poiseuille flow, the exact profile of the flow depends on a parameter called the Womersley parameter (which depends on the frequency). shows an example. The flow is:   Unidirectional axial flow (purely along the pipe)    Axisymmetric    Flow direction oscillates in time. Sometimes the flow goes in both directions at once, which can be seen in .   If we add the velocity field of Poiseuille flow onto the Womersley flow velocity field, we obtain the flow that would be driven by a pressure gradient that oscillates about a non-zero mean. Flow profiles of this sort can be seen in blood flow, since the beating of the heart provides a pressure gradient that can be approximated by a constant plus sinusoidally varying component.     Dean flow: This is a steady flow driven by a steady prescribed pressure drop along the pipe, but the pipe is curved, see . Within the pipe the flow is predominantly in the axial direction, but the centrifugal force due to the curvature drives a secondary flow across the centre of the pipe towards the outside of the bend, and then back around the walls of the pipe towards the inside of the bend. This secondary flow forms Dean vortices. This is thought to provide a possible explanation as to why the disease atherosclerosis in arteries is more common on the inside of bends in arteries, since the cells lining the artery walls are more healthy in conditions of high stress. shows shows the secondary flow in the transverse cross section, which are termed Dean vortices .      Sketch of Womersley flow velocity profile.     Sketch of Dean flow velocity profile: (a) longitudinal cross-section; (b) transverse cross-section.    "
},
{
  "id": "sec-exact-solutions-5",
  "level": "2",
  "url": "sec-exact-solutions.html#sec-exact-solutions-5",
  "type": "Example",
  "number": "6.8.3",
  "title": "Channel flow.",
  "body": " Channel flow  This is the characteristic flow seen between two fixed parallel plates driven by a steady pressure gradient. The assumptions are:   Parallel fixed plates    Two-dimensional flow    Steady flow    Fully developed flow   The resulting profile is shown in . The flow is parabolic and looks similar to a cross-section of Poiseuille flow. See also the cartoon of channel flow between two plates.   Sketch of channel flow velocity profile.    "
},
{
  "id": "sec-exact-solutions-6",
  "level": "2",
  "url": "sec-exact-solutions.html#sec-exact-solutions-6",
  "type": "Example",
  "number": "6.8.4",
  "title": "Axisymmetric Couette flow.",
  "body": " Axisymmetric Couette flow  This is the characteristic flow that is observed between cylinders that are rotating relative to one another. We assume:   Coaxial cylinders, rotating at different constant angular velocities    Two-dimensional flow (no dependence on -coordinate)    Axisymmetric flow    Steady flow   The resulting flow is illustrated in .   Sketch of axisymmetric Couette flow.    "
},
{
  "id": "example-stokes-boundary-layer",
  "level": "2",
  "url": "sec-exact-solutions.html#example-stokes-boundary-layer",
  "type": "Example",
  "number": "6.8.5",
  "title": "Stokes boundary layer.",
  "body": " Stokes boundary layer    Sketch of set up for Stokes boundary layer.    In this question you will investigate the flow field generated next to a flat oscillating plate. Assume that the plate is at with an incompressible Newtonian fluid of density and kinematic viscosity in , and that the plate oscillates purely in the -direction with displacement at time , as shown in . You may also assume that the plate and volume of fluid are large enough that you can neglect their boundaries (that is, the plate occupies the whole plane and the fluid occupies the whole of ) and that the plate has been oscillating long enough so that the whole fluid is oscillating periodically.     Write down the equations and boundary conditions governing the flow.    The fluid is governed by the Navier Stokes and continuity equations: At the boundary conditions are       Write down assumptions about the components of the fluid flow and their dependence on the spatial coordinates , and . Use this to simplify the the governing equations and boundary conditions.    We assume this is a two-dimensional flow, with and all components not depending on . In addition we assume the velocity components do not depend on (because translating the problem in the -direction is the same problem). Thus we have , , and .  The continuity equation is The first and third terms are zero by assumption, and therefore Hence is constant, and the boundary condition at implies that everywhere. The three components of the Navier Stokes equation simplify to Thus is constant in space and the only non-trivial equation is together with boundary conditions at .      Make the assumption that the flow and pressure are sinusoidal, that is and . Use this to simplify and solve the governing equations to find the velocity field.    The periodic assumption simplifies to (the other components are not needed). Substituting into the governing equation, The coefficients of must balance and the coefficients of must balance. Therefore These two equations are the complex conjugates of one another, so we only need to solve one of them, which gives the general solution The function as , and thus . The boundary condition at . Hence , meaning that . Hence       Sketch the velocity profile at time .    The velocity profile is a sinusoidal function whose amplitude decays exponentially with the distance from the surface.   Stokes boundary layer flow.    This is a famous exact solution of the Navier Stokes equations, and the flow we have found here is characteristic of the flow that exists near an oscillating boundary. Note that the flow decays away from the wall, and for this reason it is often described as a boundary later, and the solution is called Stokes boundary layer flow.    "
},
{
  "id": "sec-low-Reynolds-number-sphere",
  "level": "2",
  "url": "sec-exact-solutions.html#sec-low-Reynolds-number-sphere",
  "type": "Example",
  "number": "6.8.6",
  "title": "Low-Reynolds-number flow past a sphere (non-examinable).",
  "body": " Low-Reynolds-number flow past a sphere (non-examinable)  This section is non-examinable.   Photographs of a sphere moving through a fluid with . The top photograph is in the reference frame in which the sphere is stationary, and the bottom photograph is in a fixed frame, (note the shadow cast by the sphere is not indicative of the flow). Taken from , and see also Figs. 25, 51, 56, 58 from this book, which show the flow for higher Reynolds numbers.     Sketches of the flow field around of a fixed sphere in a moving fluid for (a) low, (b) moderate and (c) high Reynolds numbers.    In this section we find the flow around a sphere moving through a fluid at a low Reynolds number, using a Stokes streamfunction. We use this to find the drag on the sphere. shows two photographs of the same flow, but visualised in two different ways, and shows sketches of the flow for a range of Reynolds numbers.  The calculation shows that the drag force experienced by an object moving through a fluid at low Reynolds numbers can be derived from the Stokes equations. This analysis shows that the Stokes drag on a sphere is in the direction opposing motion, which holds as long as . This is a famous classical result in fluid mechanics.  This principle is used in a falling ball viscometer in which a small spherical ball of known radius and mass is dropped into a fluid, whose viscosity we wish to measure. Once the ball has reached its terminal falling velocity , the forces on it must be in equilibrium, meaning that the force of gravity balances the drag force. Assuming the sphere is small enough and going slowly enough and the fluid is viscous enough that the flow has a low Reynolds number, the drag is given by and the force of gravity is , where is the acceleration due to gravity. Thus and so measuring the terminal velocity and substituting into this equation gives an estimate of the viscosity of the fluid.  We assume the flow is axisymmetric and work in a moving reference frame centred on the sphere using spherical coordinates. As shown in , we can write the velocity in terms of a Stokes streamfunction using : From , the vorticity is given by where the differential operator is a variant of the Laplacian operator, defined by its action on a function by At low Reynolds numbers, we take the curl of the Stokes equation to give and, after some work, we may show this is equivalent to We need boundary conditions on , which are given by the following:   No-slip conditions on the surface of the sphere ( ). Using the expressions for and above, these become     As we must have uniform flow with velocity in the direction . Using the expressions for the velocity components and above, these become Combining these we get where is constant. Adding a constant onto the streamfunction does not affect the velocity, and thus we may arbitrarily set , giving    Thus we have to solve subject to the on and as . We try a separable function and the condition implies that (or a multiple thereof). Substituting into and using , after some algebra we obtain We try and obtain Thus or , and so the general solution of is    Enforcing the behaviour as , we need , and so , . Thus     Applying the boundary condition at , which must be true for all values of . Thus     Applying the boundary condition at , which must be true for all . Thus    Equations and have the solution and . Thus and we can substitute this into the expressions for the components of the velocity field to obtain the velocity:   We can also find the pressure using the Stokes equation in the form . After a lot of algebra we obtain which we solve to find where is constant.  Perhaps the most interesting application of this solution is to find the drag on the sphere, which is the total force of the fluid on the sphere, retarding the motion. Since the stress is the force per unit area on the sphere, the drag equals the integral of the stress over the surface. We find the stress using We use the expression for in spherical polar coordinates , and then gives the stress on the surface as On substituting in the expressions for the velocity components , , , we find that We express the bracket in this equation in terms of Cartesian coordinates, using the conversion formulae Substituting this into the expression for , we obtain the stress The drag equals the integral of over the surface of the sphere. The integral of the term is zero because this force cancels on opposite sides of the sphere, but the term is always in the same direction; thus the total drag force is this term times the area, which is Thus the drag force is in the direction opposing motion. This is called the Stokes drag and it is a famous result in fluid mechanics.   This derivation is extremely complicated in terms of the algebra, and you would certainly not be asked to reproduce something so long-winded as this in this course. However, you should understand the concepts, and be able to follow the general argument. In fact the mathematics presented here is very elegant indeed, and it is amazing that an exact solution exists and can be calculated.    Notice that in the course of the derivation , we made the assumption that is separable. Thus we have not rigorously shown that the solution we found was unique, that is there might be other solutions to this problem that satisfy the boundary conditions at and the condition as .    This solution is the same as the irrotational flow solution (see ). Note that for any real fluid (i.e. one with viscosity), this solution would only be seen for low Reynolds numbers, despite the fact that inviscid fluids correspond to high Reynolds numbers.   "
},
{
  "id": "example-womersley-flow",
  "level": "2",
  "url": "sec-exact-solutions.html#example-womersley-flow",
  "type": "Example",
  "number": "6.8.10",
  "title": "Womersley flow (non-examinable).",
  "body": " Womersley flow (non-examinable)   This section is non-examinable.   Womersley flow occurs in pipes in which there is an imposed oscillating pressure gradient. Characteristics of this flow are often seen in blood flow in arteries, since the flow and pressure gradient are unsteady. As for the derivation of Poiseuille flow, we consider a long, circular cylindrical pipe of radius , and work in cylindrical polar coordinates centred on the axis of the pipe. We make the following assumptions:   The flow is fully developed ; thus .    The flow is axisymmetric ; thus .    The flow has a symmetry in a diameter of the cross-section. In turn this means there is no swirl in the flow, and thus .   The derivation proceed similarly to that of Poiseuille flow (so we cover it quite briefly here). With the assumptions, the continuity equation reduces to which gives , whereupon the boundary condition implies that the constant of proportionality is zero, and hence . Thus the only flow component is the axial flow, , which, according to the assumptions, is a function of and only (and does not depend on either or ). The radial and azimuthal components of the Navier Stokes equation reduce to the equations and thus is a function of and only. The axial component of the Navier Stokes equation is Consider what happens to the three terms in this equation at fixed values of and as alone is varied. Since is not a function of , the only term that can vary is , while the other two terms stay constant. Since equality must be maintained this shows that, in fact, must be fixed as varies, and thus , where and are unknown functions of time. We set to be the pressure gradient of the flow at time .  In Poiseuille flow is fixed in time, but in Womersley flow we set , where is constant (by fixing the origin of time we may fix to be real and positive). We can write this as where denotes the complex conjugate. We try a solution of the form where is a complex-valued function, and, substituting this into , we obtain This equation must be true for all values of , which means that both of the expressions in brackets must be be zero. Since the two bracketed expressions are complex conjugates of one another, we only need to consider the first bracket. Thus This is a linear, second-order, non-constant-coefficient, non-homogeneous ordinary differential equation for . We can therefore solve it as a complementary function plus a particular integral . The particular integral is given by To find the complementary function we must solve and substituting and simplifying, we remove the coefficients on the left-hand side to obtain This equation is the standard form of a special equation called Bessel's equation. The two linearly independent solutions are called Bessel functions of order zero, and they are denoted and , see and .   Bessel functions of the first kind , and (from Wikipedia entry on Bessel functions).     Bessel functions of the second kind , and (from Wikipedia entry on Bessel functions).    We therefore obtain the complementary function where and are constants of integration, and thus where the Womersley number is a dimensionless parameter defined by To find the constants and we apply the boundary conditions and regularity conditions at the origin (as we did for Poiseuille flow):   At : The function tends to infinity as and so contributions from are not allowed, meaning that must be set to zero.    At : The no-slip boundary condition is at the wall for all times, which from means that must also be zero at . Substituting into the solution for gives    Hence and, substituting this into , we get This is Womersley flow, which was first described by Womersley in 1955. The nondimensionalised flow profile is where , , . This nondimensionalisation shows that the flow is characterised by a single parameter, the Womersley number, (as opposed to 4 dimensional parameters: , , and ). Sketches of the flow profiles for different values of are given in Figure~\\ref{fig:womersley} and some movies will be shown in the lecture.   Snapshots of sketches of Womersley flow profiles for various Womersley numbers. (a) Low Womersley number (profile is Poiseuille flow multiplied by a time-dependent factor), (b) intermediate Womersley number, (c) high Womersley number (profile is flat across the interior with a boundary layer in which the flow oscillates rapidly).     We may do a similar analysis for any prescribed periodic pressure gradient . To do this we decompose into a Fourier series sum of terms of different frequencies. We solve for the flow generated by each component of individually. The total flow is the sum of these flow components.    In the human arterial system the Womersley number of the fundamental harmonic is different in different arteries and it takes values up to about 20.    For small Womersley numbers we use the Taylor series expansion of the Bessel function: to find an approximation of . which is a Poiseuille flow profile (multiplied by an oscillating amplitude). This flow is called quasi-steady , because this is the solution that we would obtain if we neglected the time-derivative term in the Navier Stokes equation.    For large Womersley numbers we use the standard asymptotic expansions for the Bessel function, which is: when . Letting , where and are real, we can expand the cosine function: where the second approximation is valid if (which is the case we have). Substituting into , we obtain Away from the boundaries, is large and so the exponential terms in the bracket in this expression are very small, and This type of flow is called plug flow , since at any fixed time the profile is uniform across the interior.  Near the walls of the pipe the exponential terms become important. At the walls themselves, the flow is zero, and, as we move away, the expression for the velocity shows there are rapid oscillations that decrease in magnitude as we move away from the wall.  Thus we see that the flow is divided into two distinct regions. There is the core in which the dominant balance is between the pressure gradient and the inertial term (the time-derivative term), and in which the viscosity plays a minor role. Sometimes this is termed an inviscid core . The other region is the boundary layer, in which the viscosity is important. The width of the boundary layer is of the order of magnitude (often we would just say loosely that the boundary layer has width ). Within a few 's away from the boundary, the flow is affected by the presence of the boundary, but further away the effect is negligible.  Another way that we could find the flow for large Womersley number is to use boundary layer analysis in the boundary, and an inviscid flow method (such as potential flow analysis) in the interior, and match the two solutions at the edge of the boundary layer. Since we have the exact solution valid for all Womersley numbers, this method of separating into the boundary layer and core regions is not necessary to find the solution. However, in many problems, no solution can be found in the general case, but a solution can be found in the particular case when one parameter is large or small. It is surprising how often such solutions are possible in real world problems, and this method often provides significant insight into the problem.   "
},
{
  "id": "ws-viscousflows",
  "level": "1",
  ...
  "body": " Practice Exercises    We look to complete worksheets in the week prior to the content being delivered. Once this is done, this disclaimer message will be removed.     Reynolds number estimation    Based on Problem 2.1 in .   Give an order-of-magnitude estimate of the Reynolds number in each of the following situations:     flow past the wing of a jumbo jet at 150 m\/s (roughly half the speed of sound);    The kinematic viscosity of air at standard temperature and pressure is about . The wingspan of a jumbo jet is about , so the Reynolds number is approximately       blood flow in a large artery (diameter 2 cm) at 0.3 m\/s;    The kinematic viscosity of blood is about . The diameter of the artery is about , so the Reynolds number is approximately Although this is above 2000, blood flow in arteries is typically laminar.      a thick layer of honey draining off a spoon at 1 cm\/s;    The kinematic viscosity of honey is about . The thickness of the layer is about , so the Reynolds number is approximately       a spermatozoon with tail length m swimming at 100 m\/s in water.    The kinematic viscosity of water at room temperature is about . The length of the tail is about , so the Reynolds number is approximately       Nondimensionalisation    Based on Problem 2.2 in   In this problem you will work through the nondimensionalisation of a typical fluid flow problem to identify the Reynolds number as a key dimensionless parameter.  Consider the two-dimensional steady flow of a viscous incompressible fluid past a circular cylinder of radius . Far from the cylinder, the fluid velocity is uniform with magnitude in the -direction. The governing equations are the incompressible Navier Stokes equations and continuity equation: where is the velocity field, is the pressure field, is the fluid density, and is the kinematic viscosity of the fluid.     Write down suitable boundary conditions at the cylinder surface and far from the cylinder.    At the cylinder surface, we have the no-slip and no-penetration boundary conditions: Far from the cylinder, the velocity approaches the uniform flow:       Introduce nondimensional variables Rewrite the governing equations and boundary conditions in terms of these nondimensional variables.    We have: which simplify to where is the Reynolds number of the flow. The boundary conditions become: at and       You should have found that the nondimensional problem depends only on a single parameter: the Reynolds number. Thus flows at equal Reynolds numbers are geometrically similar, and one only needs to know the Reynolds number to understand the flow.  This was a particularly simple problem that has an unambiguous length and velocity scale, and so nondimensionalisation of the problem works particularly well. However, it is frequently helpful to nondimensionalise problems before solving so that key dimensionless groups of parameters (such as the Reynolds number) can be identified.      Falling ball viscometer   For slowly moving spheres, the resistive force is given by Stokes drag, and equals , where is the diameter of the sphere, is the dynamic viscosity of the fluid, and is the speed of the sphere (this is a famous result).     Check the dimensions of the Stokes drag. Is the dimension what you expect?    The dimensions of the terms are as follows: meaning that Thus the expression for the Stokes drag has the dimensions of force, as expected.      A steel ballbearing of mass , diameter falls slowly through a viscous fluid of dynamic viscosity . In this question you can neglect the buoyancy force. What are the other two forces acting on the ballbearing?    Gravity and fluid drag      Write down a differential equation for the time-evolution of the velocity of the ballbearing, assuming that the acceleration due to gravity is .    Newton's second law gives       Given that the ballbearing is released from rest, solve the differential equation to show that where and are constant parameters that you should define. What is the physical significance of and ?    We have for which the integrating factor is , and where is a constant of integration. Hence The initial condition is at , and, substituting this into the above equation, , giving . Hence We substitute and . With these substitutions we get The physical significance of these choices is that is the terminal velocity of the sphere and is the timescale over which the velocity of the sphere approaches the terminal velocity. Every units of time, the velocity of the sphere becomes closer to the terminal velocity by a factor .      Sketch the velocity as a function of time.     Sketch of velocity as a function of time.        If the ballbearing has diameter 2 mm and is falling through glycerol at 20 C, what is its terminal velocity in mm\/s and what is the timescale taken to reach the terminal velocity? You may assume that the dynamic viscosity of glycerol at 20 C is 1.2 Pa s and the density of steel is 8,000 kg\/m .    Using the fact that the volume of a sphere is , where is the diameter, we have , where kg\/m . Thus The timescale is given by       Comment on the experimental set up needed to measure the terminal velocity.    The ball would attain its terminal velocity very quickly (in much less than a second), and since is on order of centimetres per second, a container of about 10 cm deep would be suitable for measurement. In fact this idea is commonly used to measure the viscosity of fluids (since the viscosity can be calculated from the terminal velocity); this is called a falling ball viscometer .      Stress on a plate   A rigid plate of length is fixed along the line and has width in the -direction. An incompressible fluid of density and viscosity flows steadily in the shaded region , shown in .   Sketch of plate.       Given that the velocity field is what are , , , in terms of and ? Simplify the velocity components and . (Note that the fact that the coefficients on the terms in and in are equal and opposite is required to ensure incompressibility of the fluid).    We apply no-slip boundary conditions at the plate. Thus if then we must have and . Hence for all , which implies that , , and . Solving, we obtain Hence       Find the drag force on the plate.    The drag force can be found by changing coordinates from to , which are Cartesian coordinates where the -axis runs along the plate and the -axis goes from the plate perpendicularly into the fluid. You may use the fact that where , are unit vectors in the - and -directions, respectively, and , are unit vectors in the - and -directions, respectively, and is the angle between the plate and the -axis. You may use the fact that , and     We perform the coordinate transform illustrated in from the -plane to the -plane:   Sketch of plate.    We use and so the velocity components are and .  Thus the shear stress is given by and hence the drag force equals       In this part, find the drag force on the plate by using the stress tensor, and check your answer against the previous part.    We have the normal vector to the plate The rate-of-strain tensor is given by Hence the stress tensor equals The stress on the surface is given by where is the unit tangential vector to the plate in the -plane.  This is the pressure pushing into the plate (direction ) plus the drag along the plate. Hence, the total drag force is the drag times the area: which agrees with the previous answer.      Stress on a surface due to the pressure   In this problem, you will calculate the resultant force on the cube shown in due to the pressure in the surrounding fluid acting on the fluid within the cube. We will consider two different methods of calculating this force.  Note that, in this question, as with the derivation of the Navier Stokes equations , you may use some sleight of hand, so as to avoid carefully integrating the force over the surface. However, as in that case, fortunately the errors cancel and the result is correct.     Assuming that the pressure is uniform over the surface and over the surface , calculate the force on the fluid in the cube due to the pressure of the surrounding fluid on these two faces and show that it is approximately where is the volume of the cube.    The force on is pressure times area acting into the cube, which is , while the force on equals . Hence the contribution to the force from these two faces is       Similarly, calculate the force on the fluid in the cube due to the pressure of the surrounding fluid on the faces and , and on the faces and . Hence show that the total force on the fluid in the cube due to the pressure of the surrounding fluid is given by     The force on is and that on is . This gives a contribution Similarly, the force on is and that on is . This gives a contribution Hence the total force on the fluid in the cube due to the pressure of the surrounding fluid is given by       Check that you get the same result using the stress tensor of an inviscid fluid .    The unit normal to the face is , and hence the stress at a point in this face is Hence the force on this face equals . Similarly, the unit normal to the face is , and hence the stress at a point in this face is Hence the force on this face equals . Thus the contribution to the force from these two faces is The contributions from the other faces can be calculated similarly, and the total force on the fluid in the cube due to the pressure of the surrounding fluid is given by       Analysis of flow in a channel   A viscous incompressible fluid flows steadily between two stationary rigid boundaries at under a constant pressure gradient .     Write down the boundary conditions to apply at each of the plates.    The no-slip boundary conditions give for all and .      The velocity is steady and therefore independent of . Explain why it is also reasonable to assume that the velocity profile is independent of and , and also that the -component of the velocity is zero .    Since the plates are infinite in the and directions, and the pressure gradient is constant, there is no preferred location in these directions, and hence the velocity profile is independent of and . Furthermore, since there is no pressure gradient in the direction, there is no driving force for flow in this direction, and hence the -component of the velocity is zero ( ).      Use the continuity equation to show that the -component of the velocity is also zero ( ).    The continuity equation for an incompressible fluid is Since the velocity is independent of and , the first and third terms are zero, and hence Since the plates are rigid boundaries, there is no flow through them, and hence the no-penetration boundary conditions give for all and . Since is independent of and zero at both and , it follows that for all .      Hence the only non-zero component of the velocity is the -component, , and this only depends on , . Check that the profile satisfies the boundary conditions.    At , we have and at , we have Hence the profile satisfies the boundary conditions.      The velocity profile increases as increases and decreases as increases. Explain why this is to be expected. Thus, although you cannot yet prove this is the correct velocity profile (you will soon be able to do so), this profile does look reasonable from what you already know.    A larger pressure gradient means a larger driving force for the flow, and hence a larger velocity. A larger viscosity means a larger resistance to the flow, and hence a smaller velocity. Therefore, it is to be expected that the velocity profile increases as increases and decreases as increases.      Calculate the three components of the stress vector, the force per unit area that the fluid exerts, on each of the two plates. You may assume that the pressure equals at .    The pressure at a general point is given by   At , the normal stress is given by the pressure, pointing into the plate: (note the negative sign as \"into the plate\" is in the -direction). The -component of the shear stress at is given by (note that this is positive since the fluid is pushing the plate in the positive -direction). The -component of the shear stress at is zero since . Hence   At , the normal stress is given by the pressure, pointing into the plate: (note the sign change compared to the previous part as \"into the plate\" is in the -direction). The -component of the shear stress at is given by Note that the formula used has a negative sign as \"into the fluid\" is in the -direction. The overall sign is positive since the fluid is pushing the plate in the positive -direction. (It is good to check signs after this kind of calculation by checking the direction of the force.) The -component of the shear stress at is zero since . Hence       Compare the stresses on the two plates. Why is this to be expected?    The normal stresses on the two plates are equal in magnitude but opposite in direction, as expected since the pressure acts equally on both plates, but \"into the plates\" is a different direction.  The shear stresses on the two plates are equal in magnitude and direction, indicating that the fluid is exerting the same tangential force on both plates in the direction of the flow. This is also expected since the plane is a plane of symmetry.      Force on a blob of fluid    Based on Exercises 6.1 and 6.2 in .   In this exercise, you will find an expression for force per unit volume acting on an incompressible Newtonian fluid. You will do this by finding the force acting on a small blob of the fluid as an integral over its volume. First you will find a new expression for the stress vector at the blob's surface, which makes the rest of the calculation easier. with normal , and use this to find an expression for the force on a blob of fluid.     Recall that is the stress vector acting on a surface with normal , and this is given by Show that this is identical to     You may use the fact that where, in the first bracket, the operator acts on but not .    The th component of is Hence, the th component of the target expression is as required.      Hence show that the force on a blob of incompressible fluid of volume due to the surrounding fluid is given by where is the surface of the blob of fluid.    Use the following vector calculus identities:     We have We now make use of the vector calculus identities given in the hint. The first term becoems the second term becomes and for the third term, Hence, since the fluid is incompressible and , the third term becomes Combining these three results gives as required.      Deduce that, if the blob is small, the net force on it per unit volume of fluid equals .    If the blob is small, then the integrand in the expression for the force varies little over the volume of the blob, and so where is the volume of the blob. Hence the force per unit volume is given by as required.      General deformation of a fluid element    Based on Exercise 6.7 in .   In this exercise, you will consider the general deformation of a fluid element in an incompressible Newtonian fluid. You will show that the deformation can be expressed as a combination of three types of motion: translation, rotation and pure strain.  Note that, if the fluid were also compressible, there would be a fourth type of motion, namely expansion or contraction.     Let be a point in the fluid with position vector , and let be a nearby point with position vector . Explain why the velocity at point can be expressed in terms of that at point as     The velocity at point can be expressed as a Taylor series expansion about point : Since is a nearby point to , the higher order terms in are negligible, and hence we have as required.      Show that where denotes differentiation with respect to the components of , denotes differentiation with respect to the components of , and   You may use the fact that , where, in the second term on the right-hand side, the operator acts on but not     We have that the th component of the final term of the target expression is where the final equality uses the fact that the rate-of-strain tensor is symmetric . Substituting for gives   Using the given vector identity, the th component of the second term of the target expression is   Hence the th component of the sum of the second and the third terms of the target expression is which is the th component of , thus proving the result.      Explain why the three terms on the right-hand side of the expression in the previous part represent translation, rotation and pure strain, respectively.       The first term represents translation since it is the velocity at point .    The second term represents rotation since, setting , this term is of the form , which is purely rotational motion about point (see ). Note also that this again shows a result that we used in that the vorticity is twice the angular velocity since .    The third term represents pure strain since it depends on the rate-of-strain tensor , which describes how the fluid element is deformed without rotation.         Decomposition of a shear flow    Based on Exercise 6.8 in .   In this problem, you will apply the equation from the previous problem to a shear flow .     Use to decompose into its local (i) translational, (ii) rotational, and (iii) pure straining components. For (iii), find the eigenvalues and eigenvectors, which give the principle directions of strain. Sketch each of the components (ii) and (iii).  Note that this example is a special case in which the rotational and pure straining components are uniform over the fluid domain. More generally, both will vary.    (ii) The vorticity and therefore the rotational component is which is clockwise rotation with angular velocity , see left sketch in .  (iii) We have the rate-of-strain tensor Hence (note that we are interchanging between and ). The eigenvalues of satisfy which has solutions . The associated eigenvectors are This corresponds to expansion along the line and contraction along , see middle sketch in .  The solution is illustrated in .   Sketches showing the decomposition of the flow into rotation (left) and pure straining flow (middle), with the total flow shown on the right.        Derivation of the Cauchy equation   In this problem, you will derive the Cauchy equation for the conservation of linear momentum in an incompressible fluid that is not necessarily Newtonian (the Navier Stokes equation only applies to Newtonian fluids).     Consider a volume moving with the fluid that, at the time is the small cube of fluid as shown in , and apply the Reynolds Transport Theorem to the fluid in this volume.    We consider a volume with surface consisting of a small cube of side length , as shown in . We apply the Reynolds Transport Theorem to the fluid in the cube: where is any function, a vector or a scalar.  Setting equal to the momentum per unit volume in the fluid, the integral equals the momentum of the fluid in the cube, and the time derivative is the rate of change of momentum, which is the total force acting on the fluid in the cube.  The total force equals the sum of the surface forces and body forces. The body force equals the force of gravity: . The surface forces are an integral: and we sum the contributions over the six faces in pairs:   Front and back faces: The contribution on the back face ( ) is and on the front face ( ), it is The sum of these is     Left and right faces: In a similar way, the contribution is     Bottom and top faces: The contribution is    Hence, the surface force is given by   Hence Since the cube is small, the right-hand side is approximately the volume times the integrand evaluated at a point in . Dividing by gives Since is constant, Since the fluid is incompressible, we have , and, rearranging, we obtain the Cauchy equation:       Limits of low and high Reynolds number   An incompressible Newtonian fluid with density and shear viscosity flows in a space with a typical lengthscale and velocity scale .     Perform a nondimensionalisation of the Navier Stokes and continuity equations, using a scale for the pressure and for time, and writing the gravitational acceleration as , where is a unit vector in the direction of .    We have which, after nondimensionalising, become       Choose a suitable timescale so that the inertial terms balance and multiply the Navier Stokes equation by a suitable factor so that the nondimensional viscous term has coefficient 1. What do you notice about the coefficient of the inertial terms?    We set the coefficients of the two inertial terms equal: Multiplying the Navier Stokes equation by , we get The coefficient multiplying the inertial terms is the Reynolds number .      Hence, in the case of a low-Reynolds-number flow, , show that, to leading order, the equations simplify to one of the following three cases: or or Specify the conditions under which each of these equations is obtained. In the latter two cases, we term the equations governing the fluid velocity the Stokes equations .    In this case, the inertial terms are small compared to the viscous terms, so we can neglect them. The gravitational acceleration term has order of magnitude . We need to consider the cases in which this is large, order one or small:   If , the pressre have a predominantly hydrostatic pressure profile, with the fluid dynamical problem being a small perturbation to the background static problem. Thus the pressure gradient balances this term: and, to leading order, the Navier Stokes equation becomes Once we have solved this problem, we could in principle solve a secondary problem to find the fluid flow. Thus the dimensional problem is     If is of order 1, the gravitational acceleration term balances the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:     If , the gravitational acceleration term is small compared to the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:          In the case of a high-Reynolds-number flow, , show that, to leading order, the equations simplify to one of the following three cases: or or Specify the conditions under which each of these equations is obtained. In the latter two cases, we term the equations governing the fluid velocity the Euler equations .    In this case, the viscous terms are small compared to the inertial terms, so we can neglect them. Dividing the Navier Stokes equation by , The gravitational acceleration term now has order of magnitude . We need to consider the cases in which this is large, order one or small:   If , the pressre have a predominantly hydrostatic pressure profile, with the fluid dynamical problem being a small perturbation to the background static problem. Thus the pressure gradient balances this term: and, to leading order, the Navier Stokes equation becomes As in the low-Reynolds-number cases, once we have solved this problem, we could in principle solve a secondary problem to find the fluid flow. Thus the dimensional problem is     If is of order 1, the gravitational acceleration term balances the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:     If , the gravitational acceleration term is small compared to the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:          Hagen Poiseuille flow   In this exercise you will review the derivation of Poiseuille flow and prove the Hagen Poiseuille formula .     Review the derivation , making your own notes. Use the flow profile to prove the formula .    We have that the volumetric flux along the pipe equals ( is a circular cross-section of the pipe) where is the pressure gradient. Rearranging, as expected.      Flow outside a cylinder   A Newtonian incompressible fluid of density and shear viscosity surrounds a circular cylinder of radius . Working in cylindrical polar coordinates, the cylinder surface is at .  The Navier Stokes and continuity equations in cylindrical polar coordinates read: where the Laplacian is defined by its action on a function :      In the case that the surface of the cylinder is porous and there is a uniform suction inside it, which induces a steady flow into the cylinder with inflow velocity at the surface, you may assume that the flow is steady, two-dimensional and axisymmetric. With these assumptions, use the continuity equation to show that     Axisymmetry implies and two-dimensional flow implies . With these assumptions, the continuity equation becomes Multiplying by and integrating, where is constant. The boundary condition on reads , and hence Substituting this in,       Show that the Navier Stokes equations reduce to     We substitute the assumptions into the Navier Stokes equations, which state that all , and derivatives are zero and . The equations become: and Hence, the only non-trivial equation is the -component, which reduces to Substituting the expression for , which simplifies to as required.      Solve this to find the pressure field, given that the far-field pressure is .    We solve the equation, applying the boundary condition as to find that       Oscillating flow in a pipe   In this exercise, you will derive the equations for flow in a circular pipe, driven by an oscillating pressure gradient      In cylindrical polar coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid.  Stating your assumptions, use the continuity equation to show that is everywhere zero.    We assume that the flow is axisymmetric and fully developed. The continuity equation reduces to which implies that where is independent of . Regularity at implies that , and therefore everywhere.      Simplify the Navier Stokes equations, and use them to show that where You may neglect gravity.    With the assumptions, the Navier Stokes equations reduce to There is thus one non-trivial component, and, taking the part proportional to , we have which, dividing by , is equivalent to Rearranging gives the result.      Make the substitution , where , to obtain the canonical form     With this substitution, we have and hence giving       Find a particular integral to this equation, i.e. any solution that satisfies the inhomogeneous equation    For simplicity, seek a constant solution, and we find       The complementary function can be written in terms of a special function of which you are probably not aware called a Bessel function . Regularity implies that we pick the Bessel functions of the the first kind, which are shown in .  Examples of the solution for three different Womersley numbers are shown in , and . The solution for small Womersley numbers resembles the Poiseuille flow profile, while that for large Womersley numbers is plug (uniform) flow across the core of the pipe with boundary layers exhibiting rapid spatial oscillations.   Womersley flow profile for .   Womersley     Womersley flow profile for .   Womersley     Womersley flow profile for .   Womersley        Solving the Navier Stokes equations in spherical polar coordinates   A Newtonian incompressible fluid of density and shear viscosity flows in three dimensions. In spherical polar coordinates , the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid.     A sphere of radius sits in an infinite vat of fluid of density and shear viscosity . The pressure is in the far field and the surface of the sphere is at a constant pressure . Find the fluid pressure and velocity fields. You may neglect gravity.    We assume the flow and pressure fields are steady and spherically symmetric. Thus we neglect all , and derivatives, and set . The continuity equation reduces to which implies that where is independent of . The Navier Stokes equations reduce to Substituting the expression for into the -component gives which simplifies to Integrating and applying the boundary condition as gives Applying the boundary condition at gives and hence the velocity and pressure fields are       What is the volumetric flux of fluid leaving the sphere?     The volumetric flux through a spherical surface is Since the flow is axisymmetric, this equals the surface area time the radial velocity at a point on the surface:     "
},
{
  "id": "ws-viscousflows-2-1",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-2-1",
  "type": "Warning",
  "number": "6.9.1",
  "title": "",
...
{
  "id": "ws-viscousflows-3",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-3",
  "type": "Exercise",
  "number": "6.9.1",
  "title": "Reynolds number estimation.",
  "body": " Reynolds number estimation    Based on Problem 2.1 in .   Give an order-of-magnitude estimate of the Reynolds number in each of the following situations:     flow past the wing of a jumbo jet at 150 m\/s (roughly half the speed of sound);    The kinematic viscosity of air at standard temperature and pressure is about . The wingspan of a jumbo jet is about , so the Reynolds number is approximately       blood flow in a large artery (diameter 2 cm) at 0.3 m\/s;    The kinematic viscosity of blood is about . The diameter of the artery is about , so the Reynolds number is approximately Although this is above 2000, blood flow in arteries is typically laminar.      a thick layer of honey draining off a spoon at 1 cm\/s;    The kinematic viscosity of honey is about . The thickness of the layer is about , so the Reynolds number is approximately       a spermatozoon with tail length m swimming at 100 m\/s in water.    The kinematic viscosity of water at room temperature is about . The length of the tail is about , so the Reynolds number is approximately     "
},
{
  "id": "ws-viscousflows-4",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-4",
  "type": "Exercise",
  "number": "6.9.2",
  "title": "Nondimensionalisation.",
  "body": " Nondimensionalisation    Based on Problem 2.2 in   In this problem you will work through the nondimensionalisation of a typical fluid flow problem to identify the Reynolds number as a key dimensionless parameter.  Consider the two-dimensional steady flow of a viscous incompressible fluid past a circular cylinder of radius . Far from the cylinder, the fluid velocity is uniform with magnitude in the -direction. The governing equations are the incompressible Navier Stokes equations and continuity equation: where is the velocity field, is the pressure field, is the fluid density, and is the kinematic viscosity of the fluid.     Write down suitable boundary conditions at the cylinder surface and far from the cylinder.    At the cylinder surface, we have the no-slip and no-penetration boundary conditions: Far from the cylinder, the velocity approaches the uniform flow:       Introduce nondimensional variables Rewrite the governing equations and boundary conditions in terms of these nondimensional variables.    We have: which simplify to where is the Reynolds number of the flow. The boundary conditions become: at and       You should have found that the nondimensional problem depends only on a single parameter: the Reynolds number. Thus flows at equal Reynolds numbers are geometrically similar, and one only needs to know the Reynolds number to understand the flow.  This was a particularly simple problem that has an unambiguous length and velocity scale, and so nondimensionalisation of the problem works particularly well. However, it is frequently helpful to nondimensionalise problems before solving so that key dimensionless groups of parameters (such as the Reynolds number) can be identified.    "
},
{
...
},
{
  "id": "ex-channel-flow",
  "level": "2",
  "url": "ws-viscousflows.html#ex-channel-flow",
  "type": "Exercise",
  "number": "6.9.6",
  "title": "Analysis of flow in a channel.",
  "body": " Analysis of flow in a channel   A viscous incompressible fluid flows steadily between two stationary rigid boundaries at under a constant pressure gradient .     Write down the boundary conditions to apply at each of the plates.    The no-slip boundary conditions give for all and .      The velocity is steady and therefore independent of . Explain why it is also reasonable to assume that the velocity profile is independent of and , and also that the -component of the velocity is zero .    Since the plates are infinite in the and directions, and the pressure gradient is constant, there is no preferred location in these directions, and hence the velocity profile is independent of and . Furthermore, since there is no pressure gradient in the direction, there is no driving force for flow in this direction, and hence the -component of the velocity is zero ( ).      Use the continuity equation to show that the -component of the velocity is also zero ( ).    The continuity equation for an incompressible fluid is Since the velocity is independent of and , the first and third terms are zero, and hence Since the plates are rigid boundaries, there is no flow through them, and hence the no-penetration boundary conditions give for all and . Since is independent of and zero at both and , it follows that for all .      Hence the only non-zero component of the velocity is the -component, , and this only depends on , . Check that the profile satisfies the boundary conditions.    At , we have and at , we have Hence the profile satisfies the boundary conditions.      The velocity profile increases as increases and decreases as increases. Explain why this is to be expected. Thus, although you cannot yet prove this is the correct velocity profile (you will soon be able to do so), this profile does look reasonable from what you already know.    A larger pressure gradient means a larger driving force for the flow, and hence a larger velocity. A larger viscosity means a larger resistance to the flow, and hence a smaller velocity. Therefore, it is to be expected that the velocity profile increases as increases and decreases as increases.      Calculate the three components of the stress vector, the force per unit area that the fluid exerts, on each of the two plates. You may assume that the pressure equals at .    The pressure at a general point is given by   At , the normal stress is given by the pressure, pointing into the plate: (note the negative sign as \"into the plate\" is in the -direction). The -component of the shear stress at is given by (note that this is positive since the fluid is pushing the plate in the positive -direction). The -component of the shear stress at is zero since . Hence   At , the normal stress is given by the pressure, pointing into the plate: (note the sign change compared to the previous part as \"into the plate\" is in the -direction). The -component of the shear stress at is given by Note that the formula used has a negative sign as \"into the fluid\" is in the -direction. The overall sign is positive since the fluid is pushing the plate in the positive -direction. (It is good to check signs after this kind of calculation by checking the direction of the force.) The -component of the shear stress at is zero since . Hence       Compare the stresses on the two plates. Why is this to be expected?    The normal stresses on the two plates are equal in magnitude but opposite in direction, as expected since the pressure acts equally on both plates, but \"into the plates\" is a different direction.  The shear stresses on the two plates are equal in magnitude and direction, indicating that the fluid is exerting the same tangential force on both plates in the direction of the flow. This is also expected since the plane is a plane of symmetry.    "
},
{
  "id": "ws-viscousflows-9",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-9",
  "type": "Exercise",
  "number": "6.9.7",
  "title": "Force on a blob of fluid.",
  "body": " Force on a blob of fluid    Based on Exercises 6.1 and 6.2 in .   In this exercise, you will find an expression for force per unit volume acting on an incompressible Newtonian fluid. You will do this by finding the force acting on a small blob of the fluid as an integral over its volume. First you will find a new expression for the stress vector at the blob's surface, which makes the rest of the calculation easier. with normal , and use this to find an expression for the force on a blob of fluid.     Recall that is the stress vector acting on a surface with normal , and this is given by Show that this is identical to     You may use the fact that where, in the first bracket, the operator acts on but not .    The th component of is Hence, the th component of the target expression is as required.      Hence show that the force on a blob of incompressible fluid of volume due to the surrounding fluid is given by where is the surface of the blob of fluid.    Use the following vector calculus identities:     We have We now make use of the vector calculus identities given in the hint. The first term becoems the second term becomes and for the third term, Hence, since the fluid is incompressible and , the third term becomes Combining these three results gives as required.      Deduce that, if the blob is small, the net force on it per unit volume of fluid equals .    If the blob is small, then the integrand in the expression for the force varies little over the volume of the blob, and so where is the volume of the blob. Hence the force per unit volume is given by as required.    "
},
{
  "id": "ex-general-deformation-fluid-element",
  "level": "2",
  "url": "ws-viscousflows.html#ex-general-deformation-fluid-element",
  "type": "Exercise",
  "number": "6.9.8",
  "title": "General deformation of a fluid element.",
  "body": " General deformation of a fluid element    Based on Exercise 6.7 in .   In this exercise, you will consider the general deformation of a fluid element in an incompressible Newtonian fluid. You will show that the deformation can be expressed as a combination of three types of motion: translation, rotation and pure strain.  Note that, if the fluid were also compressible, there would be a fourth type of motion, namely expansion or contraction.     Let be a point in the fluid with position vector , and let be a nearby point with position vector . Explain why the velocity at point can be expressed in terms of that at point as     The velocity at point can be expressed as a Taylor series expansion about point : Since is a nearby point to , the higher order terms in are negligible, and hence we have as required.      Show that where denotes differentiation with respect to the components of , denotes differentiation with respect to the components of , and   You may use the fact that , where, in the second term on the right-hand side, the operator acts on but not     We have that the th component of the final term of the target expression is where the final equality uses the fact that the rate-of-strain tensor is symmetric . Substituting for gives   Using the given vector identity, the th component of the second term of the target expression is   Hence the th component of the sum of the second and the third terms of the target expression is which is the th component of , thus proving the result.      Explain why the three terms on the right-hand side of the expression in the previous part represent translation, rotation and pure strain, respectively.       The first term represents translation since it is the velocity at point .    The second term represents rotation since, setting , this term is of the form , which is purely rotational motion about point (see ). Note also that this again shows a result that we used in that the vorticity is twice the angular velocity since .    The third term represents pure strain since it depends on the rate-of-strain tensor , which describes how the fluid element is deformed without rotation.       "
},
{
  "id": "exercise-velocity-decomposition",
  "level": "2",
  "url": "ws-viscousflows.html#exercise-velocity-decomposition",
  "type": "Exercise",
  "number": "6.9.9",
  "title": "Decomposition of a shear flow.",
  "body": " Decomposition of a shear flow    Based on Exercise 6.8 in .   In this problem, you will apply the equation from the previous problem to a shear flow .     Use to decompose into its local (i) translational, (ii) rotational, and (iii) pure straining components. For (iii), find the eigenvalues and eigenvectors, which give the principle directions of strain. Sketch each of the components (ii) and (iii).  Note that this example is a special case in which the rotational and pure straining components are uniform over the fluid domain. More generally, both will vary.    (ii) The vorticity and therefore the rotational component is which is clockwise rotation with angular velocity , see left sketch in .  (iii) We have the rate-of-strain tensor Hence (note that we are interchanging between and ). The eigenvalues of satisfy which has solutions . The associated eigenvectors are This corresponds to expansion along the line and contraction along , see middle sketch in .  The solution is illustrated in .   Sketches showing the decomposition of the flow into rotation (left) and pure straining flow (middle), with the total flow shown on the right.      "
},
{
  ...
  "body": " Derivation of the Cauchy equation   In this problem, you will derive the Cauchy equation for the conservation of linear momentum in an incompressible fluid that is not necessarily Newtonian (the Navier Stokes equation only applies to Newtonian fluids).     Consider a volume moving with the fluid that, at the time is the small cube of fluid as shown in , and apply the Reynolds Transport Theorem to the fluid in this volume.    We consider a volume with surface consisting of a small cube of side length , as shown in . We apply the Reynolds Transport Theorem to the fluid in the cube: where is any function, a vector or a scalar.  Setting equal to the momentum per unit volume in the fluid, the integral equals the momentum of the fluid in the cube, and the time derivative is the rate of change of momentum, which is the total force acting on the fluid in the cube.  The total force equals the sum of the surface forces and body forces. The body force equals the force of gravity: . The surface forces are an integral: and we sum the contributions over the six faces in pairs:   Front and back faces: The contribution on the back face ( ) is and on the front face ( ), it is The sum of these is     Left and right faces: In a similar way, the contribution is     Bottom and top faces: The contribution is    Hence, the surface force is given by   Hence Since the cube is small, the right-hand side is approximately the volume times the integrand evaluated at a point in . Dividing by gives Since is constant, Since the fluid is incompressible, we have , and, rearranging, we obtain the Cauchy equation:     "
},
{
  "id": "ex-limits-low-high-Reynolds",
  "level": "2",
  "url": "ws-viscousflows.html#ex-limits-low-high-Reynolds",
  "type": "Exercise",
  "number": "6.9.11",
  "title": "Limits of low and high Reynolds number.",
  "body": " Limits of low and high Reynolds number   An incompressible Newtonian fluid with density and shear viscosity flows in a space with a typical lengthscale and velocity scale .     Perform a nondimensionalisation of the Navier Stokes and continuity equations, using a scale for the pressure and for time, and writing the gravitational acceleration as , where is a unit vector in the direction of .    We have which, after nondimensionalising, become       Choose a suitable timescale so that the inertial terms balance and multiply the Navier Stokes equation by a suitable factor so that the nondimensional viscous term has coefficient 1. What do you notice about the coefficient of the inertial terms?    We set the coefficients of the two inertial terms equal: Multiplying the Navier Stokes equation by , we get The coefficient multiplying the inertial terms is the Reynolds number .      Hence, in the case of a low-Reynolds-number flow, , show that, to leading order, the equations simplify to one of the following three cases: or or Specify the conditions under which each of these equations is obtained. In the latter two cases, we term the equations governing the fluid velocity the Stokes equations .    In this case, the inertial terms are small compared to the viscous terms, so we can neglect them. The gravitational acceleration term has order of magnitude . We need to consider the cases in which this is large, order one or small:   If , the pressre have a predominantly hydrostatic pressure profile, with the fluid dynamical problem being a small perturbation to the background static problem. Thus the pressure gradient balances this term: and, to leading order, the Navier Stokes equation becomes Once we have solved this problem, we could in principle solve a secondary problem to find the fluid flow. Thus the dimensional problem is     If is of order 1, the gravitational acceleration term balances the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:     If , the gravitational acceleration term is small compared to the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:          In the case of a high-Reynolds-number flow, , show that, to leading order, the equations simplify to one of the following three cases: or or Specify the conditions under which each of these equations is obtained. In the latter two cases, we term the equations governing the fluid velocity the Euler equations .    In this case, the viscous terms are small compared to the inertial terms, so we can neglect them. Dividing the Navier Stokes equation by , The gravitational acceleration term now has order of magnitude . We need to consider the cases in which this is large, order one or small:   If , the pressre have a predominantly hydrostatic pressure profile, with the fluid dynamical problem being a small perturbation to the background static problem. Thus the pressure gradient balances this term: and, to leading order, the Navier Stokes equation becomes As in the low-Reynolds-number cases, once we have solved this problem, we could in principle solve a secondary problem to find the fluid flow. Thus the dimensional problem is     If is of order 1, the gravitational acceleration term balances the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:     If , the gravitational acceleration term is small compared to the leading-order terms in the equation, and we set We obtain the leading-order system and redimensionalising, we get and the continuity equation is retained in full:        "
},
{
  "id": "ex-hagen-poiseuille-flow",
  "level": "2",
  "url": "ws-viscousflows.html#ex-hagen-poiseuille-flow",
  "type": "Exercise",
  "number": "6.9.12",
  "title": "Hagen–Poiseuille flow.",
  "body": " Hagen Poiseuille flow   In this exercise you will review the derivation of Poiseuille flow and prove the Hagen Poiseuille formula .     Review the derivation , making your own notes. Use the flow profile to prove the formula .    We have that the volumetric flux along the pipe equals ( is a circular cross-section of the pipe) where is the pressure gradient. Rearranging, as expected.    "
},
{
  "id": "ws-viscousflows-15",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-15",
  "type": "Exercise",
  "number": "6.9.13",
  "title": "Flow outside a cylinder.",
  "body": " Flow outside a cylinder   A Newtonian incompressible fluid of density and shear viscosity surrounds a circular cylinder of radius . Working in cylindrical polar coordinates, the cylinder surface is at .  The Navier Stokes and continuity equations in cylindrical polar coordinates read: where the Laplacian is defined by its action on a function :      In the case that the surface of the cylinder is porous and there is a uniform suction inside it, which induces a steady flow into the cylinder with inflow velocity at the surface, you may assume that the flow is steady, two-dimensional and axisymmetric. With these assumptions, use the continuity equation to show that     Axisymmetry implies and two-dimensional flow implies . With these assumptions, the continuity equation becomes Multiplying by and integrating, where is constant. The boundary condition on reads , and hence Substituting this in,       Show that the Navier Stokes equations reduce to     We substitute the assumptions into the Navier Stokes equations, which state that all , and derivatives are zero and . The equations become: and Hence, the only non-trivial equation is the -component, which reduces to Substituting the expression for , which simplifies to as required.      Solve this to find the pressure field, given that the far-field pressure is .    We solve the equation, applying the boundary condition as to find that     "
},
{
  "id": "ws-viscousflows-16",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-16",
  "type": "Exercise",
  "number": "6.9.14",
  "title": "Oscillating flow in a pipe.",
  "body": " Oscillating flow in a pipe   In this exercise, you will derive the equations for flow in a circular pipe, driven by an oscillating pressure gradient      In cylindrical polar coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid.  Stating your assumptions, use the continuity equation to show that is everywhere zero.    We assume that the flow is axisymmetric and fully developed. The continuity equation reduces to which implies that where is independent of . Regularity at implies that , and therefore everywhere.      Simplify the Navier Stokes equations, and use them to show that where You may neglect gravity.    With the assumptions, the Navier Stokes equations reduce to There is thus one non-trivial component, and, taking the part proportional to , we have which, dividing by , is equivalent to Rearranging gives the result.      Make the substitution , where , to obtain the canonical form     With this substitution, we have and hence giving       Find a particular integral to this equation, i.e. any solution that satisfies the inhomogeneous equation    For simplicity, seek a constant solution, and we find       The complementary function can be written in terms of a special function of which you are probably not aware called a Bessel function . Regularity implies that we pick the Bessel functions of the the first kind, which are shown in .  Examples of the solution for three different Womersley numbers are shown in , and . The solution for small Womersley numbers resembles the Poiseuille flow profile, while that for large Womersley numbers is plug (uniform) flow across the core of the pipe with boundary layers exhibiting rapid spatial oscillations.   Womersley flow profile for .   Womersley     Womersley flow profile for .   Womersley     Womersley flow profile for .   Womersley      "
},
{
  "id": "ws-viscousflows-17",
  "level": "2",
  "url": "ws-viscousflows.html#ws-viscousflows-17",
  "type": "Exercise",
  "number": "6.9.15",
  "title": "Solving the Navier–Stokes equations in spherical polar coordinates.",
  "body": " Solving the Navier Stokes equations in spherical polar coordinates   A Newtonian incompressible fluid of density and shear viscosity flows in three dimensions. In spherical polar coordinates , the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid.     A sphere of radius sits in an infinite vat of fluid of density and shear viscosity . The pressure is in the far field and the surface of the sphere is at a constant pressure . Find the fluid pressure and velocity fields. You may neglect gravity.    We assume the flow and pressure fields are steady and spherically symmetric. Thus we neglect all , and derivatives, and set . The continuity equation reduces to which implies that where is independent of . The Navier Stokes equations reduce to Substituting the expression for into the -component gives which simplifies to Integrating and applying the boundary condition as gives Applying the boundary condition at gives and hence the velocity and pressure fields are       What is the volumetric flux of fluid leaving the sphere?     The volumetric flux through a spherical surface is Since the flow is axisymmetric, this equals the surface area time the radial velocity at a point on the surface:    "
},
{
  "id": "ch-viscousflows-12",
  "level": "1",
  "url": "ch-viscousflows-12.html",
  "type": "Exercises",
  "number": "6.10",
  "title": "Problems set 7 to hand in",
  "body": " Problems set 7 to hand in   Please hand in the problems in this Section for Set 7 (due in the week commencing 1 Dec).    Analysis of flow in a pipe    It might help to try before attempting this problem.   A viscous incompressible fluid flows steadily along an infinitely long pipe of radius under a constant pressure gradient . Work in cylindrical polar coordinates with corresponding velocity components with the axis of the pipe aligned with .     Write down the boundary conditions to be applied.    The no-slip boundary conditions give       The velocity is steady and therefore independent of . Explain why it is also reasonable to assume that the velocity profile is independent of and , and also that the -component of the velocity is zero.    Assuming axisymmetric flow implies there is no dependence on and that the -component of the velocity is zero . Since the pipe is infinitely long in the -direction, and the pressure gradient is constant, there is no preferred location in this directions, and hence the velocity profile is independent of .      Use the continuity equation to show that the -component of the velocity is also zero ( ).  In cylindrical polar coordinates, the continuity equation for an incompressible fluid is     We have no - or -dependence, meaning that the continuity equation reduces to and hence , where is constant. Since the cylinder is a solid boundary, we need at . Therefore, , and so everywhere.      Hence the only non-zero component of the velocity is the -component, , and this only depends on , . Check that the profile satisfies the boundary conditions.  Note that we also need to check that the velocity is smooth at . This is easier to see if we rewrite the velocity profile in Cartesian coordinates. Converting to Cartesian coordinates, the flow is with which is smooth at . Note, however, that for example the profile would not be smooth at .    At , we have which satisfies the no-slip boundary condition.      The velocity profile increases as increases and decreases as increases. Explain why this is to be expected. Thus, although you cannot yet prove this is the correct velocity profile (you will soon be able to do so), this profile does look reasonable from what you already know.    A larger pressure gradient means a larger driving force for the flow, and hence a larger velocity. A larger viscosity means a larger resistance to the flow, and hence a smaller velocity. Therefore, it is to be expected that the velocity profile increases as increases and decreases as increases.      Calculate the three components of the stress vector, the force per unit area that the fluid exerts, on the inside of the pipe. You may assume that the pressure equals at . You may also assume that the rate-of-strain tensor in cylindrical polar coordinates is given by , and that, being a Newtonian fluid, the stress tensor is given by .    The pressure at a general point is given by   The stress vector is given by , with and . Simplifying , we have Hence, At , we have Hence the normal component of the stress vector is and the axial component of the shear stress vector is The -component of the stress vector is zero:       You should have found that the normal stress is radially outward, while the shear stress points along the pipe in the direction of increasing . Explain why you would expect these directions.    The normal stress is due to the pressure in the fluid, which acts equally in all directions, and hence the normal stress on the inside of the pipe wall points radially outward into the wall. The shear stress points along the pipe in the direction of increasing since this is the direction of the flow, and hence the fluid exerts a tangential force on the pipe wall in this direction.      Rotating flow    Based on Exercise 6.6 in .   Consider an incompressible Newtonian fluid flowing with velocity , where is a constant vector. Since is constant, for simplicity you may assume that .     Calculate the velocity components in Cartesian coordinates in the case .    We have Hence the velocity components are       Show that this flow is incompressible.    We have and hence the flow is incompressible.      Find the components of the stress tensor.    We have Hence the deviatoric stress tensor is where is the identity tensor.      Without doing a calculation, explain why you would have expected this answer.    The result shows that the deviatoric stress tensor is zero, meaning there are no viscous stresses in this flow. The only stress is due to the pressure in the fluid. This is as expected since the flow represents a solid body rotation with angular velocity . In a solid body rotation, there is no relative motion between adjacent fluid particles, and hence no viscous stresses.      Flow outside a rotating cylinder    Based on problem 2.8 in .   An incompressible Newonian fluid fills . An infinite solid cylinder of radius is placed in the fluid with its axis on the line in cylindrical polar coordinates.     The cylinder rotates at constant angular velocity about its axis. In the resulting flow, explain why it is reasonable to assume that and .    The flow and pressure are steady since the cylinder rotates at constant angular velocity. The flow and pressure have rotational symmetry and therefore no dependence on . The flow and pressure are independent of since the cylinder is infinite in this direction and there is no pressure gradient in this direction. The -component of velocity is zero since there is no motion of the cylinder or pressure gradient in this direction.      Hence perform a calculation to show that .  You may use the continuity equation in cylindrical polar coordinates:     Since there is no - or -dependence, the continuity equation reduces to and hence , where is constant. Since the cylinder is a solid boundary, we need at . Therefore, , and so everywhere.      The Navier Stokes equations in cylindrical polar coordinates are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid, which you may neglect in this question.  Show that the flow satisfies the Navier Stokes equations and boundary conditions.    Since and there is no - or -dependence, the Navier Stokes equations reduce to   The -component shows that . Now consider the -component. Substituting : Hence this flow satisfies the -component of the Navier Stokes equation.  The -component of the Navier Stokes equation is Hence for some constant , and therefore (since we have been able to find a suitable pressure), this component of the Navier Stokes equation is also satisfied.  Hence the flow satisfies the Navier Stokes equations. Finally, we check the boundary condition at : which matches the velocity of the cylinder surface.      If the fluid and cylinder are initially at rest, and the cylinder suddenly starts rotating with angular velocity at time , explain qualitatively how you would expect the flow to evolve with time.    Initially, there will be a thin boundary layer of fluid close to the cylinder surface that starts to rotate with the cylinder due to the no-slip boundary condition. As time progresses, viscous diffusion will cause the rotation to spread outwards from the cylinder surface into the fluid. Eventually, the flow will reach a steady state, which is the flow found in the previous part.     "
},
{
  "id": "ch-viscousflows-12-3",
  "level": "2",
  "url": "ch-viscousflows-12.html#ch-viscousflows-12-3",
  "type": "Exercise",
  "number": "6.10.1",
  "title": "Analysis of flow in a pipe.",
  "body": " Analysis of flow in a pipe    It might help to try before attempting this problem.   A viscous incompressible fluid flows steadily along an infinitely long pipe of radius under a constant pressure gradient . Work in cylindrical polar coordinates with corresponding velocity components with the axis of the pipe aligned with .     Write down the boundary conditions to be applied.    The no-slip boundary conditions give       The velocity is steady and therefore independent of . Explain why it is also reasonable to assume that the velocity profile is independent of and , and also that the -component of the velocity is zero.    Assuming axisymmetric flow implies there is no dependence on and that the -component of the velocity is zero . Since the pipe is infinitely long in the -direction, and the pressure gradient is constant, there is no preferred location in this directions, and hence the velocity profile is independent of .      Use the continuity equation to show that the -component of the velocity is also zero ( ).  In cylindrical polar coordinates, the continuity equation for an incompressible fluid is     We have no - or -dependence, meaning that the continuity equation reduces to and hence , where is constant. Since the cylinder is a solid boundary, we need at . Therefore, , and so everywhere.      Hence the only non-zero component of the velocity is the -component, , and this only depends on , . Check that the profile satisfies the boundary conditions.  Note that we also need to check that the velocity is smooth at . This is easier to see if we rewrite the velocity profile in Cartesian coordinates. Converting to Cartesian coordinates, the flow is with which is smooth at . Note, however, that for example the profile would not be smooth at .    At , we have which satisfies the no-slip boundary condition.      The velocity profile increases as increases and decreases as increases. Explain why this is to be expected. Thus, although you cannot yet prove this is the correct velocity profile (you will soon be able to do so), this profile does look reasonable from what you already know.    A larger pressure gradient means a larger driving force for the flow, and hence a larger velocity. A larger viscosity means a larger resistance to the flow, and hence a smaller velocity. Therefore, it is to be expected that the velocity profile increases as increases and decreases as increases.      Calculate the three components of the stress vector, the force per unit area that the fluid exerts, on the inside of the pipe. You may assume that the pressure equals at . You may also assume that the rate-of-strain tensor in cylindrical polar coordinates is given by , and that, being a Newtonian fluid, the stress tensor is given by .    The pressure at a general point is given by   The stress vector is given by , with and . Simplifying , we have Hence, At , we have Hence the normal component of the stress vector is and the axial component of the shear stress vector is The -component of the stress vector is zero:       You should have found that the normal stress is radially outward, while the shear stress points along the pipe in the direction of increasing . Explain why you would expect these directions.    The normal stress is due to the pressure in the fluid, which acts equally in all directions, and hence the normal stress on the inside of the pipe wall points radially outward into the wall. The shear stress points along the pipe in the direction of increasing since this is the direction of the flow, and hence the fluid exerts a tangential force on the pipe wall in this direction.    "
},
{
  "id": "ex-rotating-flow",
  "level": "2",
  "url": "ch-viscousflows-12.html#ex-rotating-flow",
  "type": "Exercise",
  "number": "6.10.2",
  "title": "Rotating flow.",
  "body": " Rotating flow    Based on Exercise 6.6 in .   Consider an incompressible Newtonian fluid flowing with velocity , where is a constant vector. Since is constant, for simplicity you may assume that .     Calculate the velocity components in Cartesian coordinates in the case .    We have Hence the velocity components are       Show that this flow is incompressible.    We have and hence the flow is incompressible.      Find the components of the stress tensor.    We have Hence the deviatoric stress tensor is where is the identity tensor.      Without doing a calculation, explain why you would have expected this answer.    The result shows that the deviatoric stress tensor is zero, meaning there are no viscous stresses in this flow. The only stress is due to the pressure in the fluid. This is as expected since the flow represents a solid body rotation with angular velocity . In a solid body rotation, there is no relative motion between adjacent fluid particles, and hence no viscous stresses.    "
},
{
  "id": "ch-viscousflows-12-5",
  "level": "2",
  "url": "ch-viscousflows-12.html#ch-viscousflows-12-5",
  "type": "Exercise",
  "number": "6.10.3",
  "title": "Flow outside a rotating cylinder.",
  "body": " Flow outside a rotating cylinder    Based on problem 2.8 in .   An incompressible Newonian fluid fills . An infinite solid cylinder of radius is placed in the fluid with its axis on the line in cylindrical polar coordinates.     The cylinder rotates at constant angular velocity about its axis. In the resulting flow, explain why it is reasonable to assume that and .    The flow and pressure are steady since the cylinder rotates at constant angular velocity. The flow and pressure have rotational symmetry and therefore no dependence on . The flow and pressure are independent of since the cylinder is infinite in this direction and there is no pressure gradient in this direction. The -component of velocity is zero since there is no motion of the cylinder or pressure gradient in this direction.      Hence perform a calculation to show that .  You may use the continuity equation in cylindrical polar coordinates:     Since there is no - or -dependence, the continuity equation reduces to and hence , where is constant. Since the cylinder is a solid boundary, we need at . Therefore, , and so everywhere.      The Navier Stokes equations in cylindrical polar coordinates are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid, which you may neglect in this question.  Show that the flow satisfies the Navier Stokes equations and boundary conditions.    Since and there is no - or -dependence, the Navier Stokes equations reduce to   The -component shows that . Now consider the -component. Substituting : Hence this flow satisfies the -component of the Navier Stokes equation.  The -component of the Navier Stokes equation is Hence for some constant , and therefore (since we have been able to find a suitable pressure), this component of the Navier Stokes equation is also satisfied.  Hence the flow satisfies the Navier Stokes equations. Finally, we check the boundary condition at : which matches the velocity of the cylinder surface.      If the fluid and cylinder are initially at rest, and the cylinder suddenly starts rotating with angular velocity at time , explain qualitatively how you would expect the flow to evolve with time.    Initially, there will be a thin boundary layer of fluid close to the cylinder surface that starts to rotate with the cylinder due to the no-slip boundary condition. As time progresses, viscous diffusion will cause the rotation to spread outwards from the cylinder surface into the fluid. Eventually, the flow will reach a steady state, which is the flow found in the previous part.    "
},
{
  "id": "problems-set-8",
  "level": "1",
  "url": "problems-set-8.html",
  "type": "Exercises",
  "number": "6.11",
  "title": "Problems set 8 to hand in",
  "body": " Problems set 8 to hand in   Please hand in the problems in this Section for Set 8 (the final set of problems, due in the week commencing 8 Dec).   We look to complete worksheets in the week prior to the content being delivered. Once this is done, this disclaimer message will be removed.      A tethered sphere of radius is surrounded by a flowing incompressible Newtonian fluid of density and shear viscosity . In the far field, the fluid velocity is uniform and equal to (right to left).   Flow profiles of a sphere surrounded by a flowing fluid.       Write down an expression for the Reynolds number of the fluid.     where is the characteristic velocity, is the characteristic length scale (the radius of the sphere), is the density of the fluid, and is the shear viscosity of the fluid.      Describe what you can infer about the Reynolds number in each case (a), (b) and (c) from these pictures. Explain your reasoning.       In case (a), the flow is smooth and steady around the sphere, and the flow is also reversible (left right symmetry), indicating a low Reynolds number.    In case (b), there is some disturbance in the flow behind the sphere, suggesting a moderate Reynolds number, of order 100.    In case (c), there is a turbulent wake behind the sphere, indicating a high Reynolds number, .         Channel flow   A Newtonian viscous fluid flows steadily in the -direction in two dimensions between plates at . You may neglect gravity in this problem.     Write down the boundary conditions at each plate.    We have at .      Make the assumption that the flow is fully developed and use the continuity equation to show that everywhere.    Fully-developed flow implies the velocity components do not depend on . Thus, the continuity equation reduces to implying that is independent of . The no-slip boundary conditions at each plate implies there. Hence, everywhere.      Simplify the Navier Stokes equations using the assumptions and to show that where is a constant that you should specify.    The three components of the Navier Stokes equations simplify to The -component shows the pressure only depends on , and for the two terms in the -component: Hence both these terms are constant. Setting where is constant, we have       Solve this applying the boundary conditions to find the flow profile.    We have where and are constants, and, applying the boundary condition at , and at , Subtracting these equations, we see that and then we find . Hence and .      Find the stress exerted by the fluid on both plates. If each plates has (large) area , what is the -component of the tethering force required to keep each plate fixed in place?    For the plate at , the -component of the stress is (the minus sign occurs since the vector into the fluid points in the -direction) and the -component of the stress is zero since the flow is two-dimensional. The -component equals   For the plate at , the -component of the stress is (the plus sign occurs since the vector into the fluid points in the -direction) and the -component of the stress is zero since the flow is two-dimensional. The -component equals   Thus the stress at both plates is in the -direction, and the force on the whole plate is in the -direction. Hence the tethering force to keep each plate fixed is in the -direction.  Note that it is very easy to make a sign error on this type of question. I would therefore recommend always reflecting on your answer to see if the direction you get is what you'd expect from the physics. A viscous fluid tries to drag the surface along with the flow, and so the force due to the shear stress is sometimes called the drag force . Thus, the tethering force must oppose this drag force, which is what we found.      Wavy-walled pipe   A long cylindrical pipe with slowly varying radius is aligned with its axis pointing in the -direction. A much narrower cylinder of constant radius is placed coaxially within the larger cylinder. The narrow cylinder has porous walls and emits fluid at a constant velocity perpendicular to its surface. A fluid flows steadily in the gap between the two cylinders.   Wavy-walled pipe with inner cylinder that emits fluid.    In this question, you will work in cylindrical polar coodinates , centred on the axis of the pipe.  Despite the fact that there is flow out from the inner cylinder in the radial direction, you may assume that the flow in the annular gap between the cylinders is unidirectional along the pipe in the -direction. (In reality there will be a thin layer next to the inner cylinder in which this is not true.) Furthermore, you may assume that the flow is uniform across the cross-section, that is .     Consider a narrow slice of the cylinder between and . Find an expression for the volumetric flux of fluid through the surfaces and .     Wavy-walled pipe planes to apply mass conservation.    The volumetric flux into the left-hand surface of this region equals area times velocity: and that out of the right-hand surface equals where we used the chain rule to rewrite the increments in terms of . Note that throughout this equation, we neglect and higher powers, as they are small.      Now find an expression for the volumetric flux of fluid through the section of the inner cylinder between and .    The area of the inner cylinder in this region is , and thus we have a volumetric flux entering this region from the inner cylinder.      Now use the principle of mass conservation to show that   Note that you can actually solve this equation by instead considering the volume between and . This volume has four surfaces: the inner cylinder surface , the outer cylinder surface , and the two cross-sectional surfaces at and . The inner cylinder surface gives a volume flux in of , the outer cylinder surface gives no volume flux, the surface gives a volume flux in of , and the surface gives a volume flux out of . Equating total volume flux in and volume flux out gives and hence This is true for all , hence (setting ) This was not asked for in this question.    Since the volume of the pipe between and is fixed, the total volumetric flux into this region equals the total volumetric flux out.  Thus thus proving the result.      Write down an expression for the Reynolds number of this flow, explaining your reasoning. You may assume that the pipe has length and that is a typical value of . Your answer should be in terms of the problem parameters , , , , and .    A suitable lengthscale is . Simplifying the differential equation for , by neglecting variations in pipe radius and the radius of the inner cylinder , gives suggesting a suitable velocity scale is this times (the velocity that would be attained at the end of the pipe): Hence the Reynolds number is   Many students did not find an expression for the velocity scale, and just left it as or similar. This would mean that we do not have an expression for the Reynolds number in terms of the problem parameters. Also, many students did not approximate as , which simplifies the expression (some did get , but you can go further than this).  I have added a final sentence to the question to clarify that the answer should be in terms of the problem parameters as very few students attempted to find an order of magnitude for .      State in a sentence the conditions under which it might be appropriate to assume that the velocity is uniform across the cross section. You do not need to do a calculation.    The Reynolds number would need to be large (but not so large that the flow becomes turbulent).  In the limit of large Reynolds number, we would recover the Euler equation from the Navier Stokes equation (see ). In this limit we only need a no-penetration condition ( ) and not the full no-slip conditions ( ), and so in this case uniform flow is possible.      In reality, in a sentence, what would you observe in the flow near the outer wall?    The flow would need to satisfy the no-slip boundary condition at the outer cylinder and the velocity there would therefore tend to zero.     "
},
{
  "id": "problems-set-8-2-2",
  "level": "2",
  "url": "problems-set-8.html#problems-set-8-2-2",
  "type": "Warning",
  "number": "6.11.1",
  "title": "",
  "body": " We look to complete worksheets in the week prior to the content being delivered. Once this is done, this disclaimer message will be removed.  "
},
{
  ...
  "number": "6.11.1",
  "title": "",
  "body": "  A tethered sphere of radius is surrounded by a flowing incompressible Newtonian fluid of density and shear viscosity . In the far field, the fluid velocity is uniform and equal to (right to left).   Flow profiles of a sphere surrounded by a flowing fluid.       Write down an expression for the Reynolds number of the fluid.     where is the characteristic velocity, is the characteristic length scale (the radius of the sphere), is the density of the fluid, and is the shear viscosity of the fluid.      Describe what you can infer about the Reynolds number in each case (a), (b) and (c) from these pictures. Explain your reasoning.       In case (a), the flow is smooth and steady around the sphere, and the flow is also reversible (left right symmetry), indicating a low Reynolds number.    In case (b), there is some disturbance in the flow behind the sphere, suggesting a moderate Reynolds number, of order 100.    In case (c), there is a turbulent wake behind the sphere, indicating a high Reynolds number, .       "
},
{
  "id": "problems-set-8-4",
  "level": "2",
...
},
{
  "id": "problems-set-8-5",
  "level": "2",
  "url": "problems-set-8.html#problems-set-8-5",
  "type": "Exercise",
  "number": "6.11.3",
  "title": "Wavy-walled pipe.",
  "body": " Wavy-walled pipe   A long cylindrical pipe with slowly varying radius is aligned with its axis pointing in the -direction. A much narrower cylinder of constant radius is placed coaxially within the larger cylinder. The narrow cylinder has porous walls and emits fluid at a constant velocity perpendicular to its surface. A fluid flows steadily in the gap between the two cylinders.   Wavy-walled pipe with inner cylinder that emits fluid.    In this question, you will work in cylindrical polar coodinates , centred on the axis of the pipe.  Despite the fact that there is flow out from the inner cylinder in the radial direction, you may assume that the flow in the annular gap between the cylinders is unidirectional along the pipe in the -direction. (In reality there will be a thin layer next to the inner cylinder in which this is not true.) Furthermore, you may assume that the flow is uniform across the cross-section, that is .     Consider a narrow slice of the cylinder between and . Find an expression for the volumetric flux of fluid through the surfaces and .     Wavy-walled pipe planes to apply mass conservation.    The volumetric flux into the left-hand surface of this region equals area times velocity: and that out of the right-hand surface equals where we used the chain rule to rewrite the increments in terms of . Note that throughout this equation, we neglect and higher powers, as they are small.      Now find an expression for the volumetric flux of fluid through the section of the inner cylinder between and .    The area of the inner cylinder in this region is , and thus we have a volumetric flux entering this region from the inner cylinder.      Now use the principle of mass conservation to show that   Note that you can actually solve this equation by instead considering the volume between and . This volume has four surfaces: the inner cylinder surface , the outer cylinder surface , and the two cross-sectional surfaces at and . The inner cylinder surface gives a volume flux in of , the outer cylinder surface gives no volume flux, the surface gives a volume flux in of , and the surface gives a volume flux out of . Equating total volume flux in and volume flux out gives and hence This is true for all , hence (setting ) This was not asked for in this question.    Since the volume of the pipe between and is fixed, the total volumetric flux into this region equals the total volumetric flux out.  Thus thus proving the result.      Write down an expression for the Reynolds number of this flow, explaining your reasoning. You may assume that the pipe has length and that is a typical value of . Your answer should be in terms of the problem parameters , , , , and .    A suitable lengthscale is . Simplifying the differential equation for , by neglecting variations in pipe radius and the radius of the inner cylinder , gives suggesting a suitable velocity scale is this times (the velocity that would be attained at the end of the pipe): Hence the Reynolds number is   Many students did not find an expression for the velocity scale, and just left it as or similar. This would mean that we do not have an expression for the Reynolds number in terms of the problem parameters. Also, many students did not approximate as , which simplifies the expression (some did get , but you can go further than this).  I have added a final sentence to the question to clarify that the answer should be in terms of the problem parameters as very few students attempted to find an order of magnitude for .      State in a sentence the conditions under which it might be appropriate to assume that the velocity is uniform across the cross section. You do not need to do a calculation.    The Reynolds number would need to be large (but not so large that the flow becomes turbulent).  In the limit of large Reynolds number, we would recover the Euler equation from the Navier Stokes equation (see ). In this limit we only need a no-penetration condition ( ) and not the full no-slip conditions ( ), and so in this case uniform flow is possible.      In reality, in a sentence, what would you observe in the flow near the outer wall?    The flow would need to satisfy the no-slip boundary condition at the outer cylinder and the velocity there would therefore tend to zero.    "
},
{
  "id": "solutions",
  "level": "1",
