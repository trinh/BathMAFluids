...
{
  "id": "subsec-navierstokes-discussion-9",
  "level": "2",
  "url": "sec-linear-momentum-cons.html#subsec-navierstokes-discussion-9",
  "type": "Remark",
  "number": "7.5.11",
  "title": "Navier–Stokes Equations in cylindrical coordinates.",
  "body": " Navier Stokes Equations in cylindrical coordinates  In cylindrical coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid. In the case of gravity we set , where is the acceleration due to gravity.  Note that the vector calculus operators in cylindrical (and also in spherical) coordinates are quite complicated. I would always recommend looking up the formulae, because they is very tricky to remember and extremely time-consuming to derive. A helpful website that lists these formulae along with many other useful formulae is here , and gives these formulae in the appendices, as do many other textbooks. Note in particular that the Laplacian of a vector quantity is not given by the Laplacians of its components individually.  "
},
{
  "id": "subsec-navierstokes-discussion-10",
  "level": "2",
  "url": "sec-linear-momentum-cons.html#subsec-navierstokes-discussion-10",
  "type": "Remark",
  "number": "7.5.12",
  "title": "Navier–Stokes Equations in spherical coordinates.",
  "body": " Navier Stokes Equations in spherical coordinates  In spherical coordinates the continuity equation is and the Navier Stokes equations are where the Laplacian is defined by its action on a function : and represents the body forces per unit mass acting on the fluid. Again in the case of gravity we set , where .  "
},
{
...
},
{
  ...
  "number": "7.6.1",
  "title": "Viscous dissipation of energy.",
  "body": " Viscous dissipation of energy   For an incompressible Newtonian fluid and a volume of the fluid with surface , which both move with the fluid, the rate of change of kinetic energy equals where is the dissipation due to the viscous stresses.   "
},
{
  "id": "sec-viscous-dissipation-of-energy-2-4",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-2-4",
  "type": "Proof",
  "number": "1",
  "title": "",
...
{
  "id": "sec-viscous-dissipation-of-energy-2-5",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-2-5",
  "type": "Remark",
  "number": "7.6.2",
...
{
  "id": "sec-viscous-dissipation-of-energy-2-6",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-2-6",
  "type": "Remark",
  "number": "7.6.3",
...
{
  "id": "sec-viscous-dissipation-of-energy-2-7",
  "level": "2",
  "url": "sec-viscous-dissipation-of-energy.html#sec-viscous-dissipation-of-energy-2-7",
  "type": "Remark",
  "number": "7.6.4",
...
},
{
  ...
  "body": " Examples of solutions to the Navier Stokes equations  We consider  "
},
{
...
{
  "id": "ch-viscousflows-13",
  "level": "1",
  "url": "ch-viscousflows-13.html",
  "type": "Exercises",
  "number": "7.11",
...
{
  "id": "ch-viscousflows-13-2-2",
  "level": "2",
  "url": "ch-viscousflows-13.html#ch-viscousflows-13-2-2",
  "type": "Warning",
  "number": "7.11.1",
  "title": "",
  "body": " We look to complete worksheets in the week prior to the content being delivered. Once this is done, this disclaimer message will be removed.  "
