...
{
  "id": "helmholtz-principle-9",
  "level": "2",
  "url": "sec-helmholtz.html#helmholtz-principle-9",
  "type": "Example",
  "number": "6.2.15",
...
},
{
  ...
  "number": "6.4.5",
  "title": "Two vortices.",
  "body": " Two vortices   Two vortices, of strengths and , are at the points and , respectively, in the complex plane. Write down the equations of motion for the position vectors and if the vortices are free to move. Assuming that , show that , where is the centroid of the two vortices, and is the distance between them.  Deduce that each vortex moves in a circle centred on , with angular velocity What happens in the exceptional case where ?   "
},
{
  "id": "ex-obstacle",
  "level": "2",
...
{
  "id": "subsec-newtonian-fluids-11",
  "level": "2",
  "url": "subsec-newtonian-fluids.html#subsec-newtonian-fluids-11",
  "type": "Example",
  "number": "7.4.14",
