...
},
{
  ...
  "number": "6.5.6",
  "title": "Obstacle.",
  "body": " Obstacle   Fluid occupies the region outside a circular obstacle of radius . By using the Milne-Thomson Circle Theorem, find the resulting complex potential when a vortex of strength is placed at , where (assuming there to be no circulation about the obstacle).  Explain why the vortex will move in a circle of radius with angular velocity of magnitude     The complex potential associated with a vortex in isolation at the point is The Milne-Thomson Circle Theorem states that, for a complex potential , the function has the same singularities as outside the circle and that is a streamline of the flow with complex potential . Removing the line vortex from the associated flow allows its velocity to be found.    "
},
{
  "id": "ex-quadrant",
  "level": "2",
