...
},
{
  ...
  "body": " Force on a blob of fluid   In this exercise, you will find a new expression for the stress at surface with normal , and use this to find an expression for the force on a blob of fluid.     Recall that is the stress vector acting on a surface with normal , and this is given by Show that this is identical to     Expanding, where, in the first bracket, the operator acts on but not . The th component of this expression is Hence, the th component of the target expression is as required.      Hence show that the force on a blob of incompressible fluid of volume due to the surrounding fluid is given by where is the surface of the blob of fluid.    Use the following vector calculus identities:     We have We now make use of the vector calculus identities given in the hint. The first term becoems the second term becomes and for the third term, Hence, since the fluid is incompressible and , the third term becomes Combining these three results gives as required.      Deduce that, if the blob is small, the net force on it per unit volume of fluid equals .    If the blob is small, then the integrand in the expression for the force varies little over the volume of the blob, and so where is the volume of the blob. Hence the force per unit volume is given by as required.    "
},
{
